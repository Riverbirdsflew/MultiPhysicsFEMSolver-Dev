...
from KratosMultiphysics.StructuralAnalysisApplication import auxiliary_methods_solvers

def CreateSolver(model, custom_settings):
    return ImplicitStructuralSolver(model, custom_settings)

class ImplicitStructuralSolver(StructuralSolver):
    ...
    def __init__(self, model, custom_settings):
        ...
        KratosMultiphysics.Logger.PrintInfo("::[ImplicitStructuralSolver]:: ", "Construction finished")
    ...
    def AddVariables(self):
        ...
        KratosMultiphysics.Logger.PrintInfo("::[ImplicitStructuralSolver]:: ", "Variables ADDED")

    def AddDofs(self):
        super().AddDofs()
        self._add_dynamic_dofs()
        KratosMultiphysics.Logger.PrintInfo("::[ImplicitStructuralSolver]:: ", "DOF's ADDED")
    ...
    def InitializeSolutionStep(self):
        ...
        if process_info[KratosMultiphysics.STEP] == 1 and process_info[StructuralAnalysisApplication.RESET_EQUATION_IDS]:
    ...
    def _CreateScheme(self):
        ...
        if(scheme_type == "newmark"):
            ...
            mechanical_scheme = KratosMultiphysics.ResidualBasedPseudoStaticDisplacementScheme(StructuralAnalysisApplication.RAYLEIGH_BETA)
            ...
            mechanical_scheme = StructuralAnalysisApplication.ResidualBasedRelaxationScheme(damp_factor_f, dynamic_factor_m)
        else:
