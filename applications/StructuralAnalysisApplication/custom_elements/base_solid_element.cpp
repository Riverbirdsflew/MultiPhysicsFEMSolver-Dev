    ...
    )
{
    ...
    if (StructuralAnalysisElementUtilities::HasRayleighDamping(r_prop, rCurrentProcessInfo)) {
    ...
    )
{
    ...
    const bool compute_lumped_mass_matrix = StructuralAnalysisElementUtilities::ComputeLumpedMassMatrix(r_prop, rCurrentProcessInfo);
    ...
    if (compute_lumped_mass_matrix) {
        ...
        const double density = StructuralAnalysisElementUtilities::GetDensityForMassMatrixComputation(*this, rCurrentProcessInfo);
    ...
    )
{
    ...
    StructuralAnalysisElementUtilities::CalculateRayleighDampingMatrix(
        *this,
        rDampingMatrix,
        rCurrentProcessInfo,
        mat_size);
...
int  BaseSolidElement::Check( const ProcessInfo& rCurrentProcessInfo ) const
{
    ...
    // Basic check
    check = StructuralAnalysisElementUtilities::SolidElementCheck(*this, rCurrentProcessInfo, mConstitutiveLawVector);
...
void BaseSolidElement::CalculateShapeGradientOfMassMatrix(MatrixType& rMassMatrix, ShapeParameter Deriv, const ProcessInfo& rCurrentProcessInfo) const
{
    KRATOS_TRY;
    ...
    )
{
    ...
    StructuralAnalysisElementUtilities::InitialCheckLocalAxes(r_local_axis_1, local_axis_2, local_axis_3);
    StructuralAnalysisElementUtilities::BuildRotationMatrix(rRotationMatrix, r_local_axis_1, local_axis_2, local_axis_3);
}
...
{
    return StructuralAnalysisElementUtilities::GetBodyForce(*this, rIntegrationPoints, PointNumber, rValues);
}
