...
def CreateSolverByParameters(model, solver_settings, parallelism):
    ...
    if (parallelism == "OpenMP"):
        ...
        if (solver_type == "transient" or solver_type == "Transient"):
            ...
            if time_integration_method == "implicit":
                solver_module_name = "thermal_conduction_transient_solver"
            elif time_integration_method == "explicit":
                solver_module_name = "thermal_conduction_explicit_solver"
            elif time_integration_method == "semi_implicit":
                solver_module_name = "thermal_conduction_semi_eulerian_solver"
            else:
        ...
        # Steady solver
            ...
            solver_module_name = "thermal_conduction_stationary_solver"
        # Steady Shifted Boundary Method (SBM) solver
        elif solver_type == "stationary_shifted_boundary":
            solver_module_name = "thermal_conduction_stationary_shifted_boundary_solver"
        # Steady embedded (CutFEM) solver
        elif solver_type == "stationary_embedded":
            solver_module_name = "thermal_conduction_stationary_embedded_solver"
        # Auxiliary solver to generate the stationary system matrix
        elif (solver_type == "stationary_matrix"):
            solver_module_name = "thermal_conduction_stationary_matrix_solver"
        ...
        elif (solver_type == "thermo_diffuse_mechanically_coupled" or solver_type == "ThermoDiffuseMechanicallyCoupled"):
            solver_module_name = "coupled_structural_thermal_diffuse_solver"
    ...
    module_full = 'KratosMultiphysics.ThermalConductionApplication.' + solver_module_name
