...
{
    KRATOS_ERROR << "You are calling the GetDerivative of the virtual Accessor class..." << std::endl;
    return 0.0;
}
...
double Accessor::GetIntegration(
...
{
    KRATOS_ERROR << "You are calling the GetIntegration of the virtual Accessor class..." << std::endl;
    return 0.0;
}
