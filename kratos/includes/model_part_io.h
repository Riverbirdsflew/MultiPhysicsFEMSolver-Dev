...
private:
    ...
    void ReadM4dTableBlock(M4dTablesContainerType& rM4dTables);

    void ReadM4dTableBlock(ModelPart::M4dTablesContainerType& rM4dTables);

    template<class M4dTablesContainerType>
    void WriteM4dTableBlock(M4dTablesContainerType& rM4dTables);

    void WriteM4dTableBlock(ModelPart::M4dTablesContainerType& rM4dTables);
    ...
    void ReadSubModelPartM4dTablesBlock(ModelPart& rMainModelPart, ModelPart& rSubModelPart);
    ...
    void DivideM4dTableBlock(OutputFilesContainerType& OutputFiles);
	...
	void DivideSubModelPartM4dTableBlock(OutputFilesContainerType& OutputFiles);
