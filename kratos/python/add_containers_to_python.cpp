...
void  AddContainersToPython(pybind11::module& m)
{
    ...
    py::class_<Variable<ConcentrationDiffusionSettings::Pointer > ,VariableData>(m,"ConcentrationDiffusionSettingsVariable")
    .def("__str__", PrintObject<Variable<ConcentrationDiffusionSettings::Pointer >>)//扩散
    ;
    ...
    DataValueContainerIndexingUtility< DataValueContainerBinderType, DataValueContainer, Variable<ConcentrationDiffusionSettings::Pointer> >(DataValueBinder);//扩散
    ...
    KRATOS_REGISTER_IN_PYTHON_VARIABLE(m, IS_DEFINED_MULTIPHASE )

    KRATOS_REGISTER_IN_PYTHON_VARIABLE(m, THERMAL_EXPANSION_COEFFICIENT )//热膨胀系数
    KRATOS_REGISTER_IN_PYTHON_VARIABLE(m, THERMAL_EXPANSION_COEFFICIENT_M1 )
    KRATOS_REGISTER_IN_PYTHON_VARIABLE(m, THERMAL_EXPANSION_COEFFICIENT_M2 )
    KRATOS_REGISTER_IN_PYTHON_VARIABLE(m, THERMAL_EXPANSION_COEFFICIENT_M3 )
    KRATOS_REGISTER_IN_PYTHON_VARIABLE(m, THERMAL_EXPANSION_COEFFICIENT_M4 )
    KRATOS_REGISTER_IN_PYTHON_VARIABLE(m, THERMAL_EXPANSION_COEFFICIENT_M5 )
    KRATOS_REGISTER_IN_PYTHON_VARIABLE(m, THERMAL_EXPANSION_COEFFICIENT_M6 )
    KRATOS_REGISTER_IN_PYTHON_VARIABLE(m, THERMAL_EXPANSION_COEFFICIENT_M7 )
    ...
    //KRATOS_REGISTER_IN_PYTHON_VARIABLE(m, CONCENTRATION )//扩散
    ...
    KRATOS_REGISTER_IN_PYTHON_VARIABLE(m, CONCEN_CONVECTION_COEFFICIENT)
    ...
    KRATOS_REGISTER_IN_PYTHON_VARIABLE(m,FACE_CONCENTRATION_FLUX)//扩散模块物质流
    KRATOS_REGISTER_IN_PYTHON_VARIABLE(m,HEAT_FLUX)
    KRATOS_REGISTER_IN_PYTHON_VARIABLE(m,LATENT_AUSTENIZE)
    KRATOS_REGISTER_IN_PYTHON_VARIABLE(m,LATENT_EUTECTOID_DECOMPOSITION)
    KRATOS_REGISTER_IN_PYTHON_VARIABLE(m,LATENT_BAINITE_TRANSFORMATION)
    KRATOS_REGISTER_IN_PYTHON_VARIABLE(m,LATENT_MARTENSITE_TRANSFORMATION)
    ...
    KRATOS_REGISTER_IN_PYTHON_VARIABLE(m, AMBIENT_CONCENTRATION )//扩散模块对流边界
    ...
    .def("SetDensityM1Variable",&ConvectionDiffusionSettings::SetDensityM1Variable)
    .def("SetDensityM2Variable",&ConvectionDiffusionSettings::SetDensityM2Variable)
    .def("SetDensityM3Variable",&ConvectionDiffusionSettings::SetDensityM3Variable)
    .def("SetDensityM4Variable",&ConvectionDiffusionSettings::SetDensityM4Variable)
    .def("SetDensityM5Variable",&ConvectionDiffusionSettings::SetDensityM5Variable)
    .def("SetDensityM6Variable",&ConvectionDiffusionSettings::SetDensityM6Variable)
    .def("SetDensityM7Variable",&ConvectionDiffusionSettings::SetDensityM7Variable)
    .def("SetMassFractionM1Variable",&ConvectionDiffusionSettings::SetMassFractionM1Variable)
    .def("SetMassFractionM2Variable",&ConvectionDiffusionSettings::SetMassFractionM2Variable)
    .def("SetMassFractionM3Variable",&ConvectionDiffusionSettings::SetMassFractionM3Variable)
    .def("SetMassFractionM4Variable",&ConvectionDiffusionSettings::SetMassFractionM4Variable)
    .def("SetMassFractionM5Variable",&ConvectionDiffusionSettings::SetMassFractionM5Variable)
    .def("SetMassFractionM6Variable",&ConvectionDiffusionSettings::SetMassFractionM6Variable)
    .def("SetMassFractionM7Variable",&ConvectionDiffusionSettings::SetMassFractionM7Variable)
    .def("SetDiffusionVariable",&ConvectionDiffusionSettings::SetDiffusionVariable)
    .def("SetDiffusionM1Variable",&ConvectionDiffusionSettings::SetDiffusionM1Variable)
    .def("SetDiffusionM2Variable",&ConvectionDiffusionSettings::SetDiffusionM2Variable)
    .def("SetDiffusionM3Variable",&ConvectionDiffusionSettings::SetDiffusionM3Variable)
    .def("SetDiffusionM4Variable",&ConvectionDiffusionSettings::SetDiffusionM4Variable)
    .def("SetDiffusionM5Variable",&ConvectionDiffusionSettings::SetDiffusionM5Variable)
    .def("SetDiffusionM6Variable",&ConvectionDiffusionSettings::SetDiffusionM6Variable)
    .def("SetDiffusionM7Variable",&ConvectionDiffusionSettings::SetDiffusionM7Variable)
    ...
    .def("SetLatentAustenizeVariable",&ConvectionDiffusionSettings::SetLatentAustenizeVariable)
    .def("SetLatentEutectoidVariable",&ConvectionDiffusionSettings::SetLatentEutectoidVariable)
    .def("SetLatentBainiteVariable",&ConvectionDiffusionSettings::SetLatentBainiteVariable)
    .def("SetLatentMartensiteVariable",&ConvectionDiffusionSettings::SetLatentMartensiteVariable)
    ...
    .def("SetSpecificHeatM1Variable",&ConvectionDiffusionSettings::SetSpecificHeatM1Variable)
    .def("SetSpecificHeatM2Variable",&ConvectionDiffusionSettings::SetSpecificHeatM2Variable)
    .def("SetSpecificHeatM3Variable",&ConvectionDiffusionSettings::SetSpecificHeatM3Variable)
    .def("SetSpecificHeatM4Variable",&ConvectionDiffusionSettings::SetSpecificHeatM4Variable)
    .def("SetSpecificHeatM5Variable",&ConvectionDiffusionSettings::SetSpecificHeatM5Variable)
    .def("SetSpecificHeatM6Variable",&ConvectionDiffusionSettings::SetSpecificHeatM6Variable)
    .def("SetSpecificHeatM7Variable",&ConvectionDiffusionSettings::SetSpecificHeatM7Variable)
    ...
    .def("GetDensityM1Variable",&ConvectionDiffusionSettings::GetDensityM1Variable, py::return_value_policy::reference_internal )
    .def("GetDensityM2Variable",&ConvectionDiffusionSettings::GetDensityM2Variable, py::return_value_policy::reference_internal )
    .def("GetDensityM3Variable",&ConvectionDiffusionSettings::GetDensityM3Variable, py::return_value_policy::reference_internal )
    .def("GetDensityM4Variable",&ConvectionDiffusionSettings::GetDensityM4Variable, py::return_value_policy::reference_internal )
    .def("GetDensityM5Variable",&ConvectionDiffusionSettings::GetDensityM5Variable, py::return_value_policy::reference_internal )
    .def("GetDensityM6Variable",&ConvectionDiffusionSettings::GetDensityM6Variable, py::return_value_policy::reference_internal )
    .def("GetDensityM7Variable",&ConvectionDiffusionSettings::GetDensityM7Variable, py::return_value_policy::reference_internal )
    .def("GetMassFractionM1Variable",&ConvectionDiffusionSettings::GetMassFractionM1Variable, py::return_value_policy::reference_internal )
    .def("GetMassFractionM2Variable",&ConvectionDiffusionSettings::GetMassFractionM2Variable, py::return_value_policy::reference_internal )
    .def("GetMassFractionM3Variable",&ConvectionDiffusionSettings::GetMassFractionM3Variable, py::return_value_policy::reference_internal )
    .def("GetMassFractionM4Variable",&ConvectionDiffusionSettings::GetMassFractionM4Variable, py::return_value_policy::reference_internal )
    .def("GetMassFractionM5Variable",&ConvectionDiffusionSettings::GetMassFractionM5Variable, py::return_value_policy::reference_internal )
    .def("GetMassFractionM6Variable",&ConvectionDiffusionSettings::GetMassFractionM6Variable, py::return_value_policy::reference_internal )
    .def("GetMassFractionM7Variable",&ConvectionDiffusionSettings::GetMassFractionM7Variable, py::return_value_policy::reference_internal )
    .def("GetDiffusionVariable",&ConvectionDiffusionSettings::GetDiffusionVariable, py::return_value_policy::reference_internal )
    .def("GetDiffusionM1Variable",&ConvectionDiffusionSettings::GetDiffusionM1Variable, py::return_value_policy::reference_internal )
    .def("GetDiffusionM2Variable",&ConvectionDiffusionSettings::GetDiffusionM2Variable, py::return_value_policy::reference_internal )
    .def("GetDiffusionM3Variable",&ConvectionDiffusionSettings::GetDiffusionM3Variable, py::return_value_policy::reference_internal )
    .def("GetDiffusionM4Variable",&ConvectionDiffusionSettings::GetDiffusionM4Variable, py::return_value_policy::reference_internal )
    .def("GetDiffusionM5Variable",&ConvectionDiffusionSettings::GetDiffusionM5Variable, py::return_value_policy::reference_internal )
    .def("GetDiffusionM6Variable",&ConvectionDiffusionSettings::GetDiffusionM6Variable, py::return_value_policy::reference_internal )
    .def("GetDiffusionM7Variable",&ConvectionDiffusionSettings::GetDiffusionM7Variable, py::return_value_policy::reference_internal )
    ...
    .def("GetLatentAustenizeVariable",&ConvectionDiffusionSettings::GetLatentAustenizeVariable, py::return_value_policy::reference_internal )
    .def("GetLatentEutectoidVariable",&ConvectionDiffusionSettings::GetLatentEutectoidVariable, py::return_value_policy::reference_internal )
    .def("GetLatentBainiteVariable",&ConvectionDiffusionSettings::GetLatentBainiteVariable, py::return_value_policy::reference_internal )
    .def("GetLatentMartensiteVariable",&ConvectionDiffusionSettings::GetLatentMartensiteVariable, py::return_value_policy::reference_internal )
    ...
    .def("GetSpecificHeatM1Variable",&ConvectionDiffusionSettings::GetSpecificHeatM1Variable, py::return_value_policy::reference_internal )
    .def("GetSpecificHeatM2Variable",&ConvectionDiffusionSettings::GetSpecificHeatM2Variable, py::return_value_policy::reference_internal )
    .def("GetSpecificHeatM3Variable",&ConvectionDiffusionSettings::GetSpecificHeatM3Variable, py::return_value_policy::reference_internal )
    .def("GetSpecificHeatM4Variable",&ConvectionDiffusionSettings::GetSpecificHeatM4Variable, py::return_value_policy::reference_internal )
    .def("GetSpecificHeatM5Variable",&ConvectionDiffusionSettings::GetSpecificHeatM5Variable, py::return_value_policy::reference_internal )
    .def("GetSpecificHeatM6Variable",&ConvectionDiffusionSettings::GetSpecificHeatM6Variable, py::return_value_policy::reference_internal )
    .def("GetSpecificHeatM7Variable",&ConvectionDiffusionSettings::GetSpecificHeatM7Variable, py::return_value_policy::reference_internal )
    ...
    .def("IsDefinedDensityM1Variable",&ConvectionDiffusionSettings::IsDefinedDensityM1Variable)
    .def("IsDefinedDensityM2Variable",&ConvectionDiffusionSettings::IsDefinedDensityM2Variable)
    .def("IsDefinedDensityM3Variable",&ConvectionDiffusionSettings::IsDefinedDensityM3Variable)
    .def("IsDefinedDensityM4Variable",&ConvectionDiffusionSettings::IsDefinedDensityM4Variable)
    .def("IsDefinedDensityM5Variable",&ConvectionDiffusionSettings::IsDefinedDensityM5Variable)
    .def("IsDefinedDensityM6Variable",&ConvectionDiffusionSettings::IsDefinedDensityM6Variable)
    .def("IsDefinedDensityM7Variable",&ConvectionDiffusionSettings::IsDefinedDensityM7Variable)
    .def("IsDefinedMassFractionM1Variable",&ConvectionDiffusionSettings::IsDefinedMassFractionM1Variable)
    .def("IsDefinedMassFractionM2Variable",&ConvectionDiffusionSettings::IsDefinedMassFractionM2Variable)
    .def("IsDefinedMassFractionM3Variable",&ConvectionDiffusionSettings::IsDefinedMassFractionM3Variable)
    .def("IsDefinedMassFractionM4Variable",&ConvectionDiffusionSettings::IsDefinedMassFractionM4Variable)
    .def("IsDefinedMassFractionM5Variable",&ConvectionDiffusionSettings::IsDefinedMassFractionM5Variable)
    .def("IsDefinedMassFractionM6Variable",&ConvectionDiffusionSettings::IsDefinedMassFractionM6Variable)
    .def("IsDefinedMassFractionM7Variable",&ConvectionDiffusionSettings::IsDefinedMassFractionM7Variable)
    .def("IsDefinedDiffusionVariable",&ConvectionDiffusionSettings::IsDefinedDiffusionVariable)
    .def("IsDefinedDiffusionM1Variable",&ConvectionDiffusionSettings::IsDefinedDiffusionM1Variable)
    .def("IsDefinedDiffusionM2Variable",&ConvectionDiffusionSettings::IsDefinedDiffusionM2Variable)
    .def("IsDefinedDiffusionM3Variable",&ConvectionDiffusionSettings::IsDefinedDiffusionM3Variable)
    .def("IsDefinedDiffusionM4Variable",&ConvectionDiffusionSettings::IsDefinedDiffusionM4Variable)
    .def("IsDefinedDiffusionM5Variable",&ConvectionDiffusionSettings::IsDefinedDiffusionM5Variable)
    .def("IsDefinedDiffusionM6Variable",&ConvectionDiffusionSettings::IsDefinedDiffusionM6Variable)
    .def("IsDefinedDiffusionM7Variable",&ConvectionDiffusionSettings::IsDefinedDiffusionM7Variable)
    ...
    .def("IsDefinedLatentAustenizeVariable",&ConvectionDiffusionSettings::IsDefinedLatentAustenizeVariable)
    .def("IsDefinedLatentEutectoidVariable",&ConvectionDiffusionSettings::IsDefinedLatentEutectoidVariable)
    .def("IsDefinedLatentBainiteVariable",&ConvectionDiffusionSettings::IsDefinedLatentBainiteVariable)
    .def("IsDefinedLatentMartensiteVariable",&ConvectionDiffusionSettings::IsDefinedLatentMartensiteVariable)
    ...
    .def("IsDefinedSpecificHeatM1Variable",&ConvectionDiffusionSettings::IsDefinedSpecificHeatM1Variable)
    .def("IsDefinedSpecificHeatM2Variable",&ConvectionDiffusionSettings::IsDefinedSpecificHeatM2Variable)
    .def("IsDefinedSpecificHeatM3Variable",&ConvectionDiffusionSettings::IsDefinedSpecificHeatM3Variable)
    .def("IsDefinedSpecificHeatM4Variable",&ConvectionDiffusionSettings::IsDefinedSpecificHeatM4Variable)
    .def("IsDefinedSpecificHeatM5Variable",&ConvectionDiffusionSettings::IsDefinedSpecificHeatM5Variable)
    .def("IsDefinedSpecificHeatM6Variable",&ConvectionDiffusionSettings::IsDefinedSpecificHeatM6Variable)
    .def("IsDefinedSpecificHeatM7Variable",&ConvectionDiffusionSettings::IsDefinedSpecificHeatM7Variable)
...
py::class_< ConcentrationDiffusionSettings, ConcentrationDiffusionSettings::Pointer >	(m,"ConcentrationDiffusionSettings")
    .def(py::init<	>() )
    .def("SetDiffusionVariable",&ConcentrationDiffusionSettings::SetDiffusionVariable)
    .def("SetDiffusionM1Variable",&ConcentrationDiffusionSettings::SetDiffusionM1Variable)
    .def("SetDiffusionM2Variable",&ConcentrationDiffusionSettings::SetDiffusionM2Variable)
    .def("SetDiffusionM3Variable",&ConcentrationDiffusionSettings::SetDiffusionM3Variable)
    .def("SetDiffusionM4Variable",&ConcentrationDiffusionSettings::SetDiffusionM4Variable)
    .def("SetDiffusionM5Variable",&ConcentrationDiffusionSettings::SetDiffusionM5Variable)
    .def("SetDiffusionM6Variable",&ConcentrationDiffusionSettings::SetDiffusionM6Variable)
    .def("SetDiffusionM7Variable",&ConcentrationDiffusionSettings::SetDiffusionM7Variable)
    .def("SetUnknownVariable",&ConcentrationDiffusionSettings::SetUnknownVariable)
    .def("SetPhaseFractionVariable",&ConcentrationDiffusionSettings::SetPhaseFractionVariable)
    .def("SetPhaseNameVariable",&ConcentrationDiffusionSettings::SetPhaseNameVariable)
    .def("SetVolumeSourceVariable",&ConcentrationDiffusionSettings::SetVolumeSourceVariable)
    .def("SetSurfaceSourceVariable",&ConcentrationDiffusionSettings::SetSurfaceSourceVariable)
    .def("SetProjectionVariable",&ConcentrationDiffusionSettings::SetProjectionVariable)
    .def("SetMeshVelocityVariable",&ConcentrationDiffusionSettings::SetMeshVelocityVariable)
    .def("SetConcentrationVariable",&ConcentrationDiffusionSettings::SetConcentrationVariable)
    .def("SetGradientVariable",&ConcentrationDiffusionSettings::SetGradientVariable)
    .def("SetTransferCoefficientVariable",&ConcentrationDiffusionSettings::SetTransferCoefficientVariable)
    //.def("SetSpecificHeatVariable",&ConcentrationDiffusionSettings::SetSpecificHeatVariable)
    .def("SetVelocityVariable",&ConcentrationDiffusionSettings::SetVelocityVariable)
    .def("SetReactionVariable",&ConcentrationDiffusionSettings::SetReactionVariable)
    .def("SetReactionGradientVariable",&ConcentrationDiffusionSettings::SetReactionGradientVariable)

    .def("GetDiffusionVariable",&ConcentrationDiffusionSettings::GetDiffusionVariable, py::return_value_policy::reference_internal )
    .def("GetDiffusionM1Variable",&ConcentrationDiffusionSettings::GetDiffusionM1Variable, py::return_value_policy::reference_internal )
    .def("GetDiffusionM2Variable",&ConcentrationDiffusionSettings::GetDiffusionM2Variable, py::return_value_policy::reference_internal )
    .def("GetDiffusionM3Variable",&ConcentrationDiffusionSettings::GetDiffusionM3Variable, py::return_value_policy::reference_internal )
    .def("GetDiffusionM4Variable",&ConcentrationDiffusionSettings::GetDiffusionM4Variable, py::return_value_policy::reference_internal )
    .def("GetDiffusionM5Variable",&ConcentrationDiffusionSettings::GetDiffusionM5Variable, py::return_value_policy::reference_internal )
    .def("GetDiffusionM6Variable",&ConcentrationDiffusionSettings::GetDiffusionM6Variable, py::return_value_policy::reference_internal )
    .def("GetDiffusionM7Variable",&ConcentrationDiffusionSettings::GetDiffusionM7Variable, py::return_value_policy::reference_internal )
    .def("GetUnknownVariable",&ConcentrationDiffusionSettings::GetUnknownVariable, py::return_value_policy::reference_internal )
    .def("GetPhaseFractionVariable",&ConcentrationDiffusionSettings::GetPhaseFractionVariable, py::return_value_policy::reference_internal )
    .def("GetPhaseNameVariable",&ConcentrationDiffusionSettings::GetPhaseNameVariable, py::return_value_policy::reference_internal )
    .def("GetVolumeSourceVariable",&ConcentrationDiffusionSettings::GetVolumeSourceVariable, py::return_value_policy::reference_internal )
    .def("GetSurfaceSourceVariable",&ConcentrationDiffusionSettings::GetSurfaceSourceVariable, py::return_value_policy::reference_internal )
    .def("GetProjectionVariable",&ConcentrationDiffusionSettings::GetProjectionVariable, py::return_value_policy::reference_internal )
    .def("GetMeshVelocityVariable",&ConcentrationDiffusionSettings::GetMeshVelocityVariable, py::return_value_policy::reference_internal )
    .def("GetConcentrationVariable",&ConcentrationDiffusionSettings::GetConcentrationVariable, py::return_value_policy::reference_internal )
    .def("GetGradientVariable",&ConcentrationDiffusionSettings::GetGradientVariable, py::return_value_policy::reference_internal )
    .def("GetTransferCoefficientVariable",&ConcentrationDiffusionSettings::GetTransferCoefficientVariable, py::return_value_policy::reference_internal)
    //.def("GetSpecificHeatVariable",&ConcentrationDiffusionSettings::GetSpecificHeatVariable, py::return_value_policy::reference_internal )
    .def("GetVelocityVariable",&ConcentrationDiffusionSettings::GetVelocityVariable, py::return_value_policy::reference_internal )
    .def("GetReactionVariable",&ConcentrationDiffusionSettings::GetReactionVariable, py::return_value_policy::reference_internal )
    .def("GetReactionGradientVariable",&ConcentrationDiffusionSettings::GetReactionGradientVariable, py::return_value_policy::reference_internal )

    .def("IsDefinedDiffusionVariable",&ConcentrationDiffusionSettings::IsDefinedDiffusionVariable)
    .def("IsDefinedDiffusionM1Variable",&ConcentrationDiffusionSettings::IsDefinedDiffusionM1Variable)
    .def("IsDefinedDiffusionM2Variable",&ConcentrationDiffusionSettings::IsDefinedDiffusionM2Variable)
    .def("IsDefinedDiffusionM3Variable",&ConcentrationDiffusionSettings::IsDefinedDiffusionM3Variable)
    .def("IsDefinedDiffusionM4Variable",&ConcentrationDiffusionSettings::IsDefinedDiffusionM4Variable)
    .def("IsDefinedDiffusionM5Variable",&ConcentrationDiffusionSettings::IsDefinedDiffusionM5Variable)
    .def("IsDefinedDiffusionM6Variable",&ConcentrationDiffusionSettings::IsDefinedDiffusionM6Variable)
    .def("IsDefinedDiffusionM7Variable",&ConcentrationDiffusionSettings::IsDefinedDiffusionM7Variable)
    .def("IsDefinedUnknownVariable",&ConcentrationDiffusionSettings::IsDefinedUnknownVariable)
    .def("IsDefinedPhaseFractionVariable",&ConcentrationDiffusionSettings::IsDefinedPhaseFractionVariable)
    .def("IsDefinedPhaseNameVariable",&ConcentrationDiffusionSettings::IsDefinedPhaseNameVariable)
    .def("IsDefinedVolumeSourceVariable",&ConcentrationDiffusionSettings::IsDefinedVolumeSourceVariable)
    .def("IsDefinedSurfaceSourceVariable",&ConcentrationDiffusionSettings::IsDefinedSurfaceSourceVariable)
    .def("IsDefinedProjectionVariable",&ConcentrationDiffusionSettings::IsDefinedProjectionVariable)
    .def("IsDefinedMeshVelocityVariable",&ConcentrationDiffusionSettings::IsDefinedMeshVelocityVariable)
    .def("IsDefinedConcentrationVariable",&ConcentrationDiffusionSettings::IsDefinedConcentrationVariable)
    .def("IsDefinedGradientVariable",&ConcentrationDiffusionSettings::IsDefinedGradientVariable)
    //.def("IsDefinedSpecificHeatVariable",&ConcentrationDiffusionSettings::IsDefinedSpecificHeatVariable)
    .def("IsDefinedVelocityVariable",&ConcentrationDiffusionSettings::IsDefinedVelocityVariable)
    .def("IsDefinedTransferCoefficientVariable",&ConcentrationDiffusionSettings::IsDefinedTransferCoefficientVariable)
    .def("IsDefinedReactionVariable",&ConcentrationDiffusionSettings::IsDefinedReactionVariable)
    .def("IsDefinedReactionGradientVariable",&ConcentrationDiffusionSettings::IsDefinedReactionGradientVariable)
    ;
    ...
    .def("GetSurfaceSourceVariable",&RadiationSettings::GetSurfaceSourceVariable, py::return_value_policy::reference_internal )    //.def("GetSurfaceSourceVariable",&RadiationSettings::GetSurfaceSourceVariable, py::return_value_policy::reference_internal )
    ...
    KRATOS_REGISTER_IN_PYTHON_VARIABLE(m,CONCENTRATION_DIFFUSION_SETTINGS)//扩散
