...
def CreateSolver(main_model_part, custom_settings):
    return ThermalConductionStationarySolver(main_model_part, custom_settings)

class ThermalConductionStationarySolver(thermal_conduction_solver.ThermalConductionSolver):
    ...
    def __init__(self, main_model_part, custom_settings):
        ...
        super(ThermalConductionStationarySolver, self).__init__(main_model_part, custom_settings)

        # Overwrite the base solver minimum buffer size
        buffer_2_elems = ["EulerianThermCond","AxisymmetricEulerianThermalConduction2D3N","AxisymmetricEulerianThermalConduction2D4N"] #TODO: Find a better solution
