...
// Project includes
#include "small_strain_j2_plasticity_plane_stress.h"
...
void SmallStrainJ2PlasticityPlaneStrain2D::CalculateElasticMatrix(ConstitutiveLaw::Parameters& rValues, Matrix &rElasticityTensor)
{
