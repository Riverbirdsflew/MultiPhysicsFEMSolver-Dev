...
/**
 * @class SmallStrainJ2PlasticityPlaneStrain
 ...
 */
class KRATOS_API(CONSTITUTIVE_LAWS_SMALL_STRAIN_APPLICATION) SmallStrainJ2PlasticityPlaneStrain
...
public:
    ...
    // Counted pointer
    KRATOS_CLASS_POINTER_DEFINITION(SmallStrainJ2PlasticityPlaneStrain);
     ...
     */
    SmallStrainJ2PlasticityPlaneStrain();

    /**
     * @brief Copy constructor.
     */
    SmallStrainJ2PlasticityPlaneStrain(const SmallStrainJ2PlasticityPlaneStrain& rOther);

    /**
     * @brief Destructor.
     */
    ~SmallStrainJ2PlasticityPlaneStrain() override;
