...
// Project includes
#include "../../plasticity/small_strain_j2_plasticity_3d.h"
 ...
 * @brief Defines a J2 thermal plasticity constitutive law in 3D
...
public:
    ...
    void PrintData(std::ostream& rOStream) const override {
        rOStream << "Small Strain J2 Thermal Plasticity 3D constitutive law\n";
    };
