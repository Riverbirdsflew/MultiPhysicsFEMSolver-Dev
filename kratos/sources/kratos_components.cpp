...
// void AddKratosComponent(const std::string& rName, const PhaseTransformationLaw& rComponent)
// {
//     KratosComponents<PhaseTransformationLaw>::Add(rName, rComponent);
// }
...
// void AddKratosComponent(const std::string& rName, const Variable<PhaseTransformationLaw::Pointer>& rComponent)
// {
//     KratosComponents<Variable<PhaseTransformationLaw::Pointer>>::Add(rName, rComponent);
// }
