...
// support to M4dTable
template< class TContainerType, class XVariableType, class YVariableType>
void SetM4dTableHelperFunction1(
    TContainerType& rContainer,
    const IndexType rDim,
    const XVariableType& X1Var,
    const XVariableType& X2Var,
    const XVariableType& X3Var,
    const XVariableType& X4Var,
    const YVariableType& YVar,
    const typename Properties::M4dTableType& rData)
{
    rContainer.SetM4dTable(rDim, X1Var, X2Var, X3Var, X4Var, YVar, rData);
}

template< class TContainerType, class XVariableType, class YVariableType>
typename Properties::M4dTableType& GetM4dTableHelperFunction1( 
    TContainerType& rContainer,
    const IndexType rDim,
    const XVariableType& X1Var,
    const XVariableType& X2Var,
    ...
    const YVariableType& YVar )
{
    return rContainer.GetM4dTable(rDim, X1Var, X2Var, X3Var, X4Var, YVar);
}

template< class TContainerType, class XVariableType, class YVariableType>
bool HasM4dTableHelperFunction1( 
    TContainerType& rContainer,
    const IndexType rDim,
    const XVariableType& X1Var,
    const XVariableType& X2Var,
    ...
    const YVariableType& YVar )
{
    return rContainer.HasM4dTable(rDim, X1Var, X2Var, X3Var, X4Var, YVar);
}
...
void  AddPropertiesToPython(pybind11::module& m)
{
    auto properties_module = py::class_<Properties, Properties::Pointer, Properties::BaseType>(m, "Properties")
        ...
        .def("GetM4dTable", GetM4dTableHelperFunction1<Properties, Variable<double>, Variable<double>>, py::return_value_policy::reference_internal)
        .def("SetM4dTable", SetM4dTableHelperFunction1<Properties, Variable<double>, Variable<double>>)
        .def("HasM4dTable", HasM4dTableHelperFunction1<Properties, Variable<double>, Variable<double>>)

        .def("HasVariables", &Properties::HasVariables)
        .def("HasTables", &Properties::HasTables)
        .def("HasM4dTables", &Properties::HasM4dTables)
