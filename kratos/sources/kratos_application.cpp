    ...
    : mApplicationName(ApplicationName),
      ...
      mpRegisteredObjectsName(&(Serializer::GetRegisteredObjectsName())) {
        ...
        for (auto component : {"geometries", "elements", "conditions", "constraints", "modelers", "constitutive_laws", ""
                               "phase_transformation_laws", "kinetics_models", "partition_models", "trip_models"}) {
...
void KratosApplication::RegisterKratosCore() {
    ...
    KRATOS_REGISTER_CREEP_MODEL("CreepModel", mCreepModel);
    //KRATOS_REGISTER_PHASE_TRANSFORMATION_LAW("PhaseTransformationLaw", mPhaseTransformationLaw);
    KRATOS_REGISTER_KINETICS_MODEL("KineticsModel", mKineticsModel);
    KRATOS_REGISTER_TRIP_MODEL("TripModel", mTripModel);
    KRATOS_REGISTER_PARTITION_MODEL("PartitionModel", mPartitionModel);
...
void KratosApplication::DeregisterCommonComponents()
{
    ...
    //DeregisterComponent<PhaseTransformationLaw>("phase_transformation_laws");
