...
PYBIND11_MODULE(KratosStructuralAnalysisApplication,m)
{
    namespace py = pybind11;

    py::class_<KratosStructuralAnalysisApplication,
            KratosStructuralAnalysisApplication::Pointer,
            KratosApplication >(m,"KratosStructuralAnalysisApplication")
            .def(py::init<>())
            ;
