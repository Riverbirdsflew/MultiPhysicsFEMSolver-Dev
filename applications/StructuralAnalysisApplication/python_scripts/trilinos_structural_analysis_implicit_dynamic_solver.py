...
def CreateSolver(model, custom_settings):
    return TrilinosImplicitStructuralSolver(model, custom_settings)

class TrilinosImplicitStructuralSolver(TrilinosStructuralSolver):
    ...
    def __init__(self, model, custom_settings):
        ...
        KratosMultiphysics.Logger.PrintInfo("::[TrilinosImplicitStructuralSolver]:: ", "Construction finished")
    ...
    def AddVariables(self):
        ...
        KratosMultiphysics.Logger.PrintInfo("::[TrilinosImplicitStructuralSolver]:: Variables ADDED")

    def AddDofs(self):
        super().AddDofs()
        self._add_dynamic_dofs()
        KratosMultiphysics.Logger.PrintInfo("::[TrilinosImplicitStructuralSolver]:: DOF's ADDED")
