...
void ThermalPlasticLinearPlaneStress::CalculatePK2Stress(
...
void ThermalPlasticLinearPlaneStress::CalculateElasticMatrix(
...
void ThermalPlasticLinearPlaneStress::SubstractThermalStrain(
...
{
    AdvancedConstitutiveLawSmallStrainUtilities<3>::SubstractThermalStrain(rStrainVector, ReferenceTemperature, rParameters, false);
}
