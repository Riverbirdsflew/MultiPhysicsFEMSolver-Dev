...
#if !defined(KRATOS_RESIDUALBASED_THERMAL_CONDUCTION_STRATEGY )
#define  KRATOS_RESIDUALBASED_THERMAL_CONDUCTION_STRATEGY
...
template<class TSparseSpace,
         ...
         class TLinearSolver
         >
class ResidualBasedThermalConductionStrategy
...
public:
    ...
    KRATOS_CLASS_POINTER_DEFINITION( ResidualBasedThermalConductionStrategy );
    ...
    */
    ...
    ResidualBasedThermalConductionStrategy(
...
//			mstep1->SetEchoLevel(2);
    ...
    /** Destructor.
    */
    virtual ~ResidualBasedThermalConductionStrategy() {}
...
private:
    ...
    /** Copy constructor.
    */
    ResidualBasedThermalConductionStrategy(const ResidualBasedThermalConductionStrategy& Other);
...
#endif /* KRATOS_RESIDUALBASED_THERMAL_CONDUCTION_STRATEGY  defined */
