...
namespace Kratos
{
    ...
    KRATOS_CREATE_LOCAL_FLAG(ConstitutiveLaw, COMPUTE_PHASE_TRANSFORMATION_STRAIN, 11);
    KRATOS_CREATE_LOCAL_FLAG(ConstitutiveLaw, COMPUTE_THERMAL_STRAIN, 12);
    KRATOS_CREATE_LOCAL_FLAG(ConstitutiveLaw, COMPUTE_CREEP, 13);
    KRATOS_CREATE_LOCAL_FLAG(ConstitutiveLaw, COMPUTE_TRIP, 14);
