...
#if !defined(KRATOS_RESIDUALBASED_CONCENTRATION_DIFFUSION_STRATEGY_NONLINEAR )
#define  KRATOS_RESIDUALBASED_CONCENTRATION_DIFFUSION_STRATEGY_NONLINEAR
...
/**   The concentration-diffusion problem
      ...
      due to radiation and concentration must be taken into account, and the thermal boundary condition is
...
template<class TSparseSpace,
         ...
         class TLinearSolver
         >
class ResidualBasedConcentrationDiffusionStrategyNonLinear
...
public:
    ...
    KRATOS_CLASS_POINTER_DEFINITION(ResidualBasedConcentrationDiffusionStrategyNonLinear);
    ...
    ResidualBasedConcentrationDiffusionStrategyNonLinear(
    ...
    /** Destructor.
     */
    virtual ~ResidualBasedConcentrationDiffusionStrategyNonLinear()
    {
    }
	...
	while (iter++ < mmax_iter && is_converged == false)
	  {
            ...
            T_norm = CalculateConcentrationNorm();
            CalculateProjection();
    ...
    //******************************************************************************************************
    //******************************************************************************************************
    ///calculation of concentration norm

    double CalculateConcentrationNorm()
    {
        KRATOS_TRY;
...
private:
    ...
    /** Copy constructor.
     */
    ResidualBasedConcentrationDiffusionStrategyNonLinear(const ResidualBasedConcentrationDiffusionStrategyNonLinear& Other);
...
#endif /* KRATOS_RESIDUALBASED_CONCENTRATION_DIFFUSION_STRATEGY_NONLINEAR  defined */
