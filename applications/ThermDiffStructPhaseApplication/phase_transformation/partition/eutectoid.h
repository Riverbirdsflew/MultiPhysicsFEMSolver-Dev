...
#if !defined(KRATOS_EUTECTOID)
#define  KRATOS_EUTECTOID
 ...
 * Base class of trip.
 */
class KRATOS_API(THERM_DIFF_STRUCT_PHASE_APPLICATION) Eutectoid : public PartitionModel
{
public:
     ...
     */
    KRATOS_CLASS_POINTER_DEFINITION(Eutectoid);
