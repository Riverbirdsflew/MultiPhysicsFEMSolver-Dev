 ...
 */
namespace StructuralAnalysisElementUtilities {
 ...
 */
bool KRATOS_API(STRUCTURAL_ANALYSIS_APPLICATION) ComputeLumpedMassMatrix(
 ...
 */
double KRATOS_API(STRUCTURAL_ANALYSIS_APPLICATION) GetDensityForMassMatrixComputation(const Element& rElement, const ProcessInfo& rCurrentProcessInfo);
 ...
 */
void KRATOS_API(STRUCTURAL_ANALYSIS_APPLICATION) CalculateRayleighDampingMatrix(
    Element& rElement,
 ...
 */
double KRATOS_API(STRUCTURAL_ANALYSIS_APPLICATION) CalculateReferenceLength2D2N(const Element& rElement);
 ...
 */
double KRATOS_API(STRUCTURAL_ANALYSIS_APPLICATION) CalculateCurrentLength2D2N(const Element& rElement);
 ...
 * @return reference length
 */
double KRATOS_API(STRUCTURAL_ANALYSIS_APPLICATION) CalculateReferenceLength3D2N(const Element& rElement);
 ...
 * @return current length
 */
double KRATOS_API(STRUCTURAL_ANALYSIS_APPLICATION) CalculateCurrentLength3D2N(const Element& rElement);
