...
class CoupledThermoMechanicalSolver(PythonSolver):
    ...
    def PrepareModelPart(self):
        ...
        print("domaiiin size", self.domain_size)
        ...
        if self.domain_size == 2:
            ...
            if elem.Info() == "Element3D4N" or elem.Info() == "SmallDisplacementElement3D4N":
                modeler.GenerateModelPart(self.structural_solver.main_model_part,
                                      self.thermal_solver.main_model_part,
                                      "EulerianThermCondElement3D4N",
                                      "ThermalFace3D3N")
            elif elem.Info() == "Element3D8N" or elem.Info() == "SmallDisplacementElement3D8N":
                modeler.GenerateModelPart(self.structural_solver.main_model_part,
                                      self.thermal_solver.main_model_part,
        ...
        #for elem in self.thermal_solver.main_model_part.Elements:
            #print(f"Element ID: {elem.Id}, Thermal Model Part Elements: {elem.GetElementTypeAsString()}")
