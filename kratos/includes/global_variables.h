...
namespace Kratos::Globals
{
    ...
    constexpr double SqrtTwoThird = 0.816496580927726032732428024901963798200641057818751732366488064L;
    constexpr double SqrtThirdTwo = 1.224744871391589049098642037352945695982961086728751598549732096L;
