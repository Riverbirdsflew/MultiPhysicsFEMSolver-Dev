...
/**
 * @class SmallStrainJ2Elasticity3D
 ...
 */
class KRATOS_API(CONSTITUTIVE_LAWS_SMALL_STRAIN_APPLICATION) SmallStrainJ2Elasticity3D
...
public:
    ...
    /// Counted pointer of SmallStrainJ2Elasticity3D
    KRATOS_CLASS_POINTER_DEFINITION( SmallStrainJ2Elasticity3D );
     ...
     * Copy constructor.
     */
    SmallStrainJ2Elasticity3D (const SmallStrainJ2Elasticity3D& rOther);

    /**
     * @brief Destructor.
     */
    ~SmallStrainJ2Elasticity3D() override;
     ...
     */
    virtual void GetLawFeatures(Features& rFeatures) override;
    ...
    */
    ...
    /**
     * @brief Returns the expected strain measure of this constitutive law (strain measure small displacements)
    ...
    /**
     * @brief Returns the stress measure of this constitutive law (small strain case: Cauchy stress)
...
protected:
    ...
    */
    ...
    /**
     * @brief It calculates the stress vector, use PK2 stress, equal to Cauchy stress
