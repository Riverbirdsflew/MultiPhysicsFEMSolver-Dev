...
#if !defined(KRATOS_TRIP_MODEL)
#define  KRATOS_TRIP_MODEL
 ...
 * Base class of trip.
 */
class KRATOS_API(PHASE_TRANSITIONS_APPLICATION) TripModel : public Flags
{
public:
     ...
     */
    KRATOS_CLASS_POINTER_DEFINITION(TripModel);
     ...
     *      return p_clone;
     */
    virtual TripModel::Pointer Clone() const;
    ...
    virtual double GetEqTripInc(const Properties& rMaterialProperties,
                                const GeometryType& rElementGeometry,
    ...
    {
        rOStream << "TripModel" << std::endl;
    }

    /// Print object's data.
    virtual void PrintData(std::ostream& rOStream) const override
    {
      rOStream << "TripModel has no data" << std::endl;
    }
...
KRATOS_API_EXTERN template class KRATOS_API(PHASE_TRANSITIONS_APPLICATION) KratosComponents<TripModel >;
KRATOS_API_EXTERN template class KRATOS_API(PHASE_TRANSITIONS_APPLICATION) KratosComponents< Variable<TripModel::Pointer> >;

void KRATOS_API(PHASE_TRANSITIONS_APPLICATION) AddKratosComponent(std::string const& Name, TripModel const& ThisComponent);
void KRATOS_API(PHASE_TRANSITIONS_APPLICATION) AddKratosComponent(std::string const& Name, Variable<TripModel::Pointer> const& ThisComponent);
...
KRATOS_DEFINE_VARIABLE(TripModel::Pointer, TRIP_MODEL)
