 ...
 * Base class of trip.
 */
class KRATOS_API(THERM_DIFF_STRUCT_PHASE_APPLICATION) Udef : public KineticsModel
{
public:
     ...
     */
    KRATOS_CLASS_POINTER_DEFINITION(Udef);
