    ...
    )
{
    ...
    const double E = ConstitutiveLawUtilities<6>::CalculateMultiPhaseProperties(YOUNG_MODULUS, rValues);//multiphase, 通过accessor
    const double NU = ConstitutiveLawUtilities<6>::CalculateMultiPhaseProperties(POISSON_RATIO, rValues);//multiphase, 通过accessor
