...
namespace Kratos::Python
{
    ...
    //registering variables in python
      ...
      KRATOS_REGISTER_IN_PYTHON_VARIABLE(m, YOUNG_MODULUS_M1 )
      KRATOS_REGISTER_IN_PYTHON_VARIABLE(m, YOUNG_MODULUS_M2 )
      KRATOS_REGISTER_IN_PYTHON_VARIABLE(m, YOUNG_MODULUS_M3 )
      KRATOS_REGISTER_IN_PYTHON_VARIABLE(m, YOUNG_MODULUS_M4 )
      KRATOS_REGISTER_IN_PYTHON_VARIABLE(m, YOUNG_MODULUS_M5 )
      KRATOS_REGISTER_IN_PYTHON_VARIABLE(m, YOUNG_MODULUS_M6 )
      KRATOS_REGISTER_IN_PYTHON_VARIABLE(m, YOUNG_MODULUS_M7 )
      KRATOS_REGISTER_IN_PYTHON_VARIABLE(m, POISSON_RATIO )
      KRATOS_REGISTER_IN_PYTHON_VARIABLE(m, POISSON_RATIO_M1 )
      KRATOS_REGISTER_IN_PYTHON_VARIABLE(m, POISSON_RATIO_M2 )
      KRATOS_REGISTER_IN_PYTHON_VARIABLE(m, POISSON_RATIO_M3 )
      KRATOS_REGISTER_IN_PYTHON_VARIABLE(m, POISSON_RATIO_M4 )
      KRATOS_REGISTER_IN_PYTHON_VARIABLE(m, POISSON_RATIO_M5 )
      KRATOS_REGISTER_IN_PYTHON_VARIABLE(m, POISSON_RATIO_M6 )
      KRATOS_REGISTER_IN_PYTHON_VARIABLE(m, POISSON_RATIO_M7 )
...
//       KRATOS_REGISTER_IN_PYTHON_VARIABLE(m, CONSTITUTIVE_MATRIX )
      ...
      // Initial State
      KRATOS_REGISTER_IN_PYTHON_VARIABLE(m, INITIAL_STRAIN_VECTOR )
