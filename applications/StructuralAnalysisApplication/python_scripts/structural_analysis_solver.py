...
# Import applications
import KratosMultiphysics.StructuralAnalysisApplication as StructuralAnalysisApplication

# Importing the base class
from KratosMultiphysics.python_solver import PythonSolver

# Other imports
from KratosMultiphysics.StructuralAnalysisApplication import convergence_criteria_factory
...
class StructuralSolver(PythonSolver):
    ...
    def __init__(self, model, custom_settings):
        ...
        for old_setting in old_unused_settings:
            if custom_settings.Has(old_setting):
                KratosMultiphysics.Logger.PrintWarning("::[StructuralSolver]:: ", 'Settings contain no longer used setting, please remove it: "{}"'.format(old_setting))
        ...
        if settings_have_use_block_builder:
            kratos_utilities.IssueDeprecationWarning('StructuralSolver', 'Using "block_builder", please move it to "builder_and_solver_settings" as "use_block_builder"')
        ...
        if settings_have_line_search:
            kratos_utilities.IssueDeprecationWarning('StructuralSolver', 'Using "line_search", please move it to "solving_strategy_settings" as "type"')
        ...
        # Printing message
        KratosMultiphysics.Logger.PrintInfo("::[StructuralSolver]:: ", "Construction finished")
    ...
    def AddVariables(self):
        ...
        self.main_model_part.AddNodalSolutionStepVariable(StructuralAnalysisApplication.POINT_LOAD)
        self.main_model_part.AddNodalSolutionStepVariable(StructuralAnalysisApplication.LINE_LOAD)
        self.main_model_part.AddNodalSolutionStepVariable(StructuralAnalysisApplication.SURFACE_LOAD)
        self.main_model_part.AddNodalSolutionStepVariable(KratosMultiphysics.VOLUME_ACCELERATION)
        # Add multiphase fraction
        self.main_model_part.AddNodalSolutionStepVariable(KratosMultiphysics.MASS_FRACTION_M1)
        self.main_model_part.AddNodalSolutionStepVariable(KratosMultiphysics.MASS_FRACTION_M2)
        self.main_model_part.AddNodalSolutionStepVariable(KratosMultiphysics.MASS_FRACTION_M3)
        self.main_model_part.AddNodalSolutionStepVariable(KratosMultiphysics.MASS_FRACTION_M4)
        self.main_model_part.AddNodalSolutionStepVariable(KratosMultiphysics.MASS_FRACTION_M5)
        self.main_model_part.AddNodalSolutionStepVariable(KratosMultiphysics.MASS_FRACTION_M6)
        self.main_model_part.AddNodalSolutionStepVariable(KratosMultiphysics.MASS_FRACTION_M7)
        if self.settings["rotation_dofs"].GetBool():
            # Add specific variables for the problem (rotation dofs).
            self.main_model_part.AddNodalSolutionStepVariable(KratosMultiphysics.ROTATION)
            self.main_model_part.AddNodalSolutionStepVariable(KratosMultiphysics.REACTION_MOMENT)
            self.main_model_part.AddNodalSolutionStepVariable(StructuralAnalysisApplication.POINT_MOMENT)
        if self.settings["volumetric_strain_dofs"].GetBool():
            ...
            self.main_model_part.AddNodalSolutionStepVariable(StructuralAnalysisApplication.REACTION_STRAIN)
        if self.settings["displacement_control"].GetBool():
            # Add displacement-control variables
            self.main_model_part.AddNodalSolutionStepVariable(StructuralAnalysisApplication.LOAD_FACTOR)
            self.main_model_part.AddNodalSolutionStepVariable(StructuralAnalysisApplication.PRESCRIBED_DISPLACEMENT)
        # Add variables that the user defined in the ProjectParameters
        auxiliary_solver_utilities.AddVariables(self.main_model_part, self.settings["auxiliary_variables_list"])
        KratosMultiphysics.Logger.PrintInfo("::[StructuralSolver]:: ", "Variables ADDED")
    ...
    def AddDofs(self):
        ...
        KratosMultiphysics.Logger.PrintInfo("::[StructuralSolver]:: ", "DOF's ADDED")
    ...
    def PrepareModelPart(self):
        ...
        KratosMultiphysics.Logger.PrintInfo("::[StructuralSolver]::", "ModelPart prepared for Solver.")

    def Initialize(self):
        """Perform initialization after adding nodal variables and dofs to the main model part. """
        KratosMultiphysics.Logger.PrintInfo("::[StructuralSolver]:: ", "Initializing ...")
        ...
        KratosMultiphysics.Logger.PrintInfo("::[StructuralSolver]:: ", "Finished initialization.")
    ...
    def SolveSolutionStep(self):
        ...
        if not is_converged:
            ...
            KratosMultiphysics.Logger.PrintWarning("::[StructuralSolver]:: ",msg)
        return is_converged
    ...
    def ComputeDeltaTime(self):
        if self.settings["time_stepping"].Has("time_step"):
            ...
            raise Exception("::[StructuralSolver]:: Time stepping not defined!")
    ...
    def _execute_after_reading(self):
        ...
        if materials_imported:
            KratosMultiphysics.Logger.PrintInfo("::[StructuralSolver]:: ", "Constitutive law was successfully imported.")
        else:
            KratosMultiphysics.Logger.PrintInfo("::[StructuralSolver]:: ", "Constitutive law was not imported.")
    ...
    def _CreateLinearSolver(self):
        ...
        if linear_solver_configuration.Has("solver_type"): # user specified a linear solver
            ...
            KratosMultiphysics.Logger.PrintInfo('::[StructuralSolver]:: No linear solver was specified, using fastest available solver')
