 ...
 */
class KRATOS_API(CONSTITUTIVE_LAWS_SMALL_STRAIN_APPLICATION) SmallStrainJ2Plasticity3D
...
protected:
    ...
    double mEquivalentPlasticStrain; /// The previous equivalent plastic strain
     ...
     * @param rEquivalentPlasticStrain
     */
    ...
    double GetDgamma(const double NormStressTrial, ConstitutiveLaw::Parameters& rValues,
                                     const double EquivalentPlasticStrainOld);

    /**
     * @brief This method gets the plastic potential
     * @param rMaterialProperties The properties of the material
     * @return The plastic potential
     */
    double GetPlasticPotential(const Properties& rMaterialProperties, const double EquivalentPlasticStrain);

    /**
     * @brief This method gets the yield stress
     * @param rMaterialProperties The properties of the material
     * @return The yield stress
     */
    double GetYieldStress(ConstitutiveLaw::Parameters& rValues, const double EquivalentPlasticStrain);
     ...
     */
    virtual void CalculateTangentMatrix(const double DGamma, const double NormStressTrial,
                                        const Vector &rYFNormalVector,
                                        ConstitutiveLaw::Parameters& rValues,
                                        const double EquivalentPlasticStrain, Matrix &rTMatrix);
