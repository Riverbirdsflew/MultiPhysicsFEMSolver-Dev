...
#if !defined(KRATOS_TRIANGULAR_CONCENDIFF_ELEM_H_INCLUDED )
#define  KRATOS_TRIANGULAR_CONCENDIFF_ELEM_H_INCLUDED
...
/// A stabilized element for solving the concentration diffusion equations in 2D.
...
public:
    ...
    /// Counted pointer of ConcenDiff2D
    // typedef GeometryData::IntegrationMethod IntegrationMethod;
    KRATOS_CLASS_INTRUSIVE_POINTER_DEFINITION(ConcenDiff2D);
    ...
    /// Default constructor.
    ConcenDiff2D(IndexType NewId, GeometryType::Pointer pGeometry);
    ConcenDiff2D(IndexType NewId, GeometryType::Pointer pGeometry,  PropertiesType::Pointer pProperties);

    /// Destructor.
    virtual ~ConcenDiff2D();
   ...
   /* double ComputeSmagorinskyViscosity(const BoundedMatrix<double, 3, 2 > & DN_DX,const double& h,const double& C,const double nu);*/
