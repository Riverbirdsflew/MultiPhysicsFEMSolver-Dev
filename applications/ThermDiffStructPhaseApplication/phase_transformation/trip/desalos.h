...
#if !defined(KRATOS_DESALOS)
#define  KRATOS_DESALOS
 ...
 * Base class of trip.
 */
class KRATOS_API(PHASE_TRANSFORMATION_APPLICATION) Desalos : public TripModel
{
public:
     ...
     */
    KRATOS_CLASS_POINTER_DEFINITION(Desalos);
    ...
    /**
     * @return The working space dimension of the current model
