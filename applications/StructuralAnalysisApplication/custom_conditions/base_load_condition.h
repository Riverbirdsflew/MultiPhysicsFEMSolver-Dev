 ...
 * @brief This is the base class of all the load conditions on StructuralAnalysisApplication
 * @author Riccardo Rossi
 * @author Vicente Mataix Ferrandiz
 */
class KRATOS_API(STRUCTURAL_ANALYSIS_APPLICATION)  BaseLoadCondition
    : public Condition
{
public:
