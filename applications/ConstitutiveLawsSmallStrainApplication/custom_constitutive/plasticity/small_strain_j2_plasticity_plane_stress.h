 ...
 * @brief Defines a J2 plasticity constitutive law in 2D (Plane Stress)
 ...
 */
class KRATOS_API(CONSTITUTIVE_LAWS_SMALL_STRAIN_APPLICATION) SmallStrainJ2PlasticityPlaneStrain2D
