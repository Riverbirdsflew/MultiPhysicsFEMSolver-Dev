...
class ConvectionDiffusionSolver(PythonSolver):
    ...
    def PrepareModelPart(self):
        ...
        if not self.is_restarted():
            ...
            mesh_is_tetrahedral = any(elem.GetGeometry().WorkingSpaceDimension() == 3 and len(elem.GetNodes()) == 4 
                           for elem in self.main_model_part.Elements)

            if mesh_is_tetrahedral:
                KratosMultiphysics.Logger.PrintInfo("::[ConvectionDiffusionSolver]:: ", "Checking TetrahedralMesh Orientation ")
