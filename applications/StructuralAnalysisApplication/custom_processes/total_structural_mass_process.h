...
*/
class KRATOS_API(STRUCTURAL_ANALYSIS_APPLICATION) TotalStructuralMassProcess
    : public Process
{
public:
    ///@name Type Definitions
    ...
    static double CalculateElementMass(Element& rElement, const std::size_t DomainSize, const ProcessInfo& rCurrentProcessInfo);
