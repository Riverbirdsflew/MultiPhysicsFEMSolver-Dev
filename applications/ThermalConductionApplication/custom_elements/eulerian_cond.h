...
#if !defined(KRATOS_EULERIAN_CONDUCTION_ELEMENT_INCLUDED )
#define  KRATOS_EULERIAN_CONDUCTION_ELEMENT_INCLUDED
...
class EulerianConductionElement
    : public Element
{
public:
    ///@name Type Definitions
    ...
    /// Counted pointer of
    KRATOS_CLASS_INTRUSIVE_POINTER_DEFINITION(EulerianConductionElement);
    ...
    EulerianConductionElement(IndexType NewId, GeometryType::Pointer pGeometry)
    : Element(NewId, pGeometry)
    {}

    EulerianConductionElement(IndexType NewId, GeometryType::Pointer pGeometry, PropertiesType::Pointer pProperties)
    : Element(NewId, pGeometry, pProperties)
    {}

    /// Destructor.
    virtual ~EulerianConductionElement() {};
    ...
    {
        return Kratos::make_intrusive<EulerianConductionElement>(NewId, GetGeometry().Create(ThisNodes), pProperties);
    }

    Element::Pointer Create(IndexType NewId, GeometryType::Pointer pGeom, PropertiesType::Pointer pProperties) const override
    {
        return Kratos::make_intrusive<EulerianConductionElement>(NewId, pGeom, pProperties);
    }
...
protected:
    ...
    EulerianConductionElement() : Element()
    {
    }
...
#endif // KRATOS_EULERIAN_CONDUCTION_ELEMENT_INCLUDED  defined
