...
/**
 * @class ThermalPlasticIsotropic3D
 ...
 */
class KRATOS_API(CONSTITUTIVE_LAWS_SMALL_STRAIN_APPLICATION) ThermalPlasticIsotropic3D
...
public:
    ...
    KRATOS_CLASS_POINTER_DEFINITION(ThermalPlasticIsotropic3D);
    ...
    {
        return Kratos::make_shared<ThermalPlasticIsotropic3D>(*this);
    }
     ...
     * @brief Destructor.
     */
    ~ThermalPlasticIsotropic3D() override {}

    /**
    * Copy constructor.
    */
    ThermalPlasticIsotropic3D(const ThermalPlasticIsotropic3D &rOther)
        : BaseType(rOther),
