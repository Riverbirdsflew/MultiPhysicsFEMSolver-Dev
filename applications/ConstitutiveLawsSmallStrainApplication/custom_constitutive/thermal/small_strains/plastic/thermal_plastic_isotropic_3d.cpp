...
void ThermalPlasticIsotropic3D::CalculateMaterialResponsePK2(ConstitutiveLaw::Parameters& rValues)
{
    KRATOS_TRY
...
void ThermalPlasticIsotropic3D::SubstractThermalStrain(
...
{
    AdvancedConstitutiveLawSmallStrainUtilities<6>::SubstractThermalStrain(rStrainVector, ReferenceTemperature, rParameters);
}

/***********************************************************************************/
/***********************************************************************************/

int ThermalPlasticIsotropic3D::Check(
...
double& ThermalPlasticIsotropic3D::CalculateValue(
...
void ThermalPlasticIsotropic3D::InitializeMaterial(
    const Properties& rMaterialProperties,
    const GeometryType& rElementGeometry,
...
void ThermalPlasticIsotropic3D::CalculatePK2Stress(
    ...
    )
{
    ...
    const double E = ConstitutiveLawUtilities<6>::CalculateMultiPhaseProperties(YOUNG_MODULUS, rValues);//multiphase, through accessor
...
void ThermalPlasticIsotropic3D::CalculateElasticMatrix(
