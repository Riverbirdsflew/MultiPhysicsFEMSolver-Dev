...
# Import applications
import KratosMultiphysics.ThermDiffStructPhaseApllication as KratosTDSP
import KratosMultiphysics.StructuralAnalysisApplication as KratosStructural
...
class ThermDiffStructPhaseCoupledSolver(PythonSolver):
    ...
    def SolveSolutionStep(self):
        ...
        while (nl_it < self.max_nl_it):
            ...
            if self._CheckFSIConvergence(nl_it, dis_residual_norm):
                KratosMultiphysics.Logger.PrintInfo('ThermDiffStructPhaseCoupledSolver', 'FSI non-linear iteration convergence achieved in {0} iterations.'.format(nl_it))
                is_converged = True
                break
            else:
                nl_it += 1
            ...
            if nl_it == self.max_nl_it:
                KratosMultiphysics.Logger.PrintWarning('ThermDiffStructPhaseCoupledSolver', 'FSI non-linear maximum iterations {0} reached'.format(self.max_nl_it))
    ...
    def _AuxiliaryInitOperations(self):
        ...
        KratosMultiphysics.Logger.PrintInfo("ThermDiffStructPhaseCoupledSolver", "Fluid solver construction finished.")
        ...
        KratosMultiphysics.Logger.PrintInfo("ThermDiffStructPhaseCoupledSolver", "ALE mesh solver construction finished.")
    ...
    def _CreateFSICouplingInterfaceStructure(self):
        ...
        KratosMultiphysics.Logger.PrintInfo('ThermDiffStructPhaseCoupledSolver', 'Structure FSI coupling interface created')
    ...
    def __CreateFSICouplingInterfaceFluid(self, fluid_interface_side):
        ...
        KratosMultiphysics.Logger.PrintInfo('ThermDiffStructPhaseCoupledSolver', 'Fluid {} FSI coupling interface created'.format(fluid_interface_side))
    ...
    def _CreateConvergenceAccelerator(self):
        ...
        KratosMultiphysics.Logger.PrintInfo('ThermDiffStructPhaseCoupledSolver', 'Coupling strategy construction finished')
    ...
    def _CheckFSIConvergence(self, nl_it, residual_norm):
        ...
        KratosMultiphysics.Logger.PrintInfo('ThermDiffStructPhaseCoupledSolver', 'FSI non-linear iteration = {0} |res|/sqrt(nDOFS) = {1}'.format(nl_it, normalised_residual))
