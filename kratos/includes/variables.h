...
namespace Kratos
{
    ...
    KRATOS_DEFINE_VARIABLE(bool, IS_DEFINED_MULTIPHASE )
    ...
    KRATOS_DEFINE_VARIABLE( double, FACE_CONCENTRATION_FLUX )//物质流
    ...
    KRATOS_DEFINE_VARIABLE( double, YOUNG_MODULUS_AUSTENITE )
    KRATOS_DEFINE_VARIABLE( double, YOUNG_MODULUS_FERRITE )
    KRATOS_DEFINE_VARIABLE( double, YOUNG_MODULUS_CEMENTITE )
    KRATOS_DEFINE_VARIABLE( double, YOUNG_MODULUS_PEARLITE )
    KRATOS_DEFINE_VARIABLE( double, YOUNG_MODULUS_UPPER_BAINITE )
    KRATOS_DEFINE_VARIABLE( double, YOUNG_MODULUS_LOWER_BAINITE )
    KRATOS_DEFINE_VARIABLE( double, YOUNG_MODULUS_MARTENSITE )
    //泊松比
    ...
    // 物质面对流系数
    KRATOS_DEFINE_VARIABLE( double, CONCEN_CONVECTION_COEFFICIENT )
    ...
    KRATOS_DEFINE_VARIABLE( double, LATENT_BAINITIC)
    KRATOS_DEFINE_VARIABLE( double, LATENT_MARTENSITIC)
    ...
    KRATOS_DEFINE_VARIABLE( double, DIFFUSE_CONDCTIVITY_AUSTENITE )
    KRATOS_DEFINE_VARIABLE( double, DIFFUSE_CONDCTIVITY_FERRITE )
    KRATOS_DEFINE_VARIABLE( double, DIFFUSE_CONDCTIVITY_CEMENTITE )
    KRATOS_DEFINE_VARIABLE( double, DIFFUSE_CONDCTIVITY_PEARLITE )
    KRATOS_DEFINE_VARIABLE( double, DIFFUSE_CONDCTIVITY_UPPER_BAINITE )
    KRATOS_DEFINE_VARIABLE( double, DIFFUSE_CONDCTIVITY_LOWER_BAINITE )
    KRATOS_DEFINE_VARIABLE( double, DIFFUSE_CONDCTIVITY_MARTENSITE )
    //比热
