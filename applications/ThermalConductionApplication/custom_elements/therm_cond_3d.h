...
#if !defined(KRATOS_THERMCOND_ELEM_3D_H_INCLUDED )
#define  KRATOS_THERMCOND_ELEM_3D_H_INCLUDED
...
/** A stabilized element for solving the convection diffusion problem in 3D. @see ThermCond2D
*/
class ThermCond3D
    : public Element
{
public:
    ...
    /// Counted pointer of ThermCond3D
    KRATOS_CLASS_INTRUSIVE_POINTER_DEFINITION(ThermCond3D);
    ...
    /// Default constructor.
    ThermCond3D(IndexType NewId, GeometryType::Pointer pGeometry);
    ThermCond3D(IndexType NewId, GeometryType::Pointer pGeometry,  PropertiesType::Pointer pProperties);
...
// 		static array_1d<double,4> ms_u_DN;
    ...
    /// Assignment operator.
    //ThermCond3D& operator=(const ThermCond3D& rOther);

    /// Copy constructor.
    //ThermCond3D(const ThermCond3D& rOther);
...
#endif // KRATOS_THERMCOND_ELEM_3D_H_INCLUDED  defined
