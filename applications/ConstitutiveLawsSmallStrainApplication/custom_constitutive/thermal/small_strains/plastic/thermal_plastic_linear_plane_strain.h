...
// Project includes
#include "thermal_plastic_isotropic_3d.h"
...
/**
 * @class ThermalPlasticLinearPlaneStrain
 ...
 */
class KRATOS_API(CONSTITUTIVE_LAWS_APPLICATION) ThermalPlasticLinearPlaneStrain
    : public ThermalPlasticIsotropic3D
{
public:
    ...
    using BaseType = ThermalPlasticIsotropic3D;
    ...
    /// Counted pointer of ThermalPlasticLinearPlaneStrain
    KRATOS_CLASS_POINTER_DEFINITION(ThermalPlasticLinearPlaneStrain);
     ...
     */
    ThermalPlasticLinearPlaneStrain() 
    {}
    ...
    {
        return Kratos::make_shared<ThermalPlasticLinearPlaneStrain>(*this);
    }
     ...
     * @brief Destructor.
     */
    ~ThermalPlasticLinearPlaneStrain() override {}

    /**
    * Copy constructor.
    */
    ThermalPlasticLinearPlaneStrain(const ThermalPlasticLinearPlaneStrain &rOther)
        : BaseType(rOther)
    {
    }
...
private:
    ...
    {
        KRATOS_SERIALIZE_SAVE_BASE_CLASS(rSerializer, ThermalPlasticIsotropic3D)
    }

    void load(Serializer& rSerializer) override
    {
        KRATOS_SERIALIZE_LOAD_BASE_CLASS(rSerializer, ThermalPlasticIsotropic3D)
    }
