...
# Other imports
from KratosMultiphysics.StructuralAnalysisApplication import trilinos_convergence_criteria_factory as convergence_criteria_factory

def CreateSolver(model, custom_settings):
    return TrilinosStructuralSolver(model, custom_settings)

class TrilinosStructuralSolver(StructuralSolver):
    """The base class for trilinos structural analysis solver.
    ...
    def __init__(self, model, custom_settings):
        ...
        KratosMultiphysics.Logger.PrintInfo("::[TrilinosStructuralSolver]:: ", "Construction finished")
    ...
    def AddVariables(self):
        ...
        KratosMultiphysics.Logger.PrintInfo("::[TrilinosStructuralSolver]:: ", "Variables ADDED")

    def ImportModelPart(self):
        KratosMultiphysics.Logger.PrintInfo("::[TrilinosStructuralSolver]:: ", "Importing model part.")
        self.distributed_model_part_importer = DistributedImportModelPartUtility(self.main_model_part, self.settings)
        self.distributed_model_part_importer.ImportModelPart()
        KratosMultiphysics.Logger.PrintInfo("::[TrilinosStructuralSolver]:: ", "Finished importing model part.")

    def PrepareModelPart(self):
        super().PrepareModelPart()
        # Construct the mpi-communicator
        self.distributed_model_part_importer.CreateCommunicators()
        KratosMultiphysics.Logger.PrintInfo("::[TrilinosStructuralSolver]::", "ModelPart prepared for Solver.")
