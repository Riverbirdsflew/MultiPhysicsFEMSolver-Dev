...
KRATOS_CREATE_VARIABLE(bool, IS_DEFINED_MULTIPHASE)
...
KRATOS_CREATE_VARIABLE(double, FACE_CONCENTRATION_FLUX)//扩散
...
//多相杨氏模量
KRATOS_CREATE_VARIABLE(double, YOUNG_MODULUS_AUSTENITE)
KRATOS_CREATE_VARIABLE(double, YOUNG_MODULUS_FERRITE)
KRATOS_CREATE_VARIABLE(double, YOUNG_MODULUS_CEMENTITE)
KRATOS_CREATE_VARIABLE(double, YOUNG_MODULUS_PEARLITE)
KRATOS_CREATE_VARIABLE(double, YOUNG_MODULUS_UPPER_BAINITE)
KRATOS_CREATE_VARIABLE(double, YOUNG_MODULUS_LOWER_BAINITE)
KRATOS_CREATE_VARIABLE(double, YOUNG_MODULUS_MARTENSITE)
//泊松比
...
//热膨胀系数
KRATOS_CREATE_VARIABLE(double, THERMAL_EXPANSION_COEFFICIENT)//热膨胀系数
...
KRATOS_CREATE_VARIABLE(double, CONCEN_CONVECTION_COEFFICIENT) //扩散模块面对流系数
...
KRATOS_CREATE_VARIABLE(double, LATENT_BAINITIC)
KRATOS_CREATE_VARIABLE(double, LATENT_MARTENSITIC)
...
KRATOS_CREATE_VARIABLE(double, DIFFUSE_CONDCTIVITY_AUSTENITE )
KRATOS_CREATE_VARIABLE(double, DIFFUSE_CONDCTIVITY_FERRITE )
KRATOS_CREATE_VARIABLE(double, DIFFUSE_CONDCTIVITY_CEMENTITE )
KRATOS_CREATE_VARIABLE(double, DIFFUSE_CONDCTIVITY_PEARLITE )
KRATOS_CREATE_VARIABLE(double, DIFFUSE_CONDCTIVITY_UPPER_BAINITE )
KRATOS_CREATE_VARIABLE(double, DIFFUSE_CONDCTIVITY_LOWER_BAINITE )
KRATOS_CREATE_VARIABLE(double, DIFFUSE_CONDCTIVITY_MARTENSITE )
//比热
...
// phase trans 
KRATOS_CREATE_VARIABLE(PhaseTransformationLaw::Pointer, PHASE_TRANSFORMATION_LAW)
KRATOS_CREATE_VARIABLE(KineticsModel::Pointer, KINETICS_MODEL)
KRATOS_CREATE_VARIABLE(PartitionModel::Pointer, PARTITION_MODEL)
KRATOS_CREATE_VARIABLE(TripModel::Pointer, TRIP_MODEL)
KRATOS_CREATE_VARIABLE(CreepModel::Pointer, CREEP_MODEL)
...
KRATOS_CREATE_VARIABLE(ConcentrationDiffusionSettings::Pointer, CONCENTRATION_DIFFUSION_SETTINGS)//添加扩散模块
...
void KratosApplication::RegisterVariables() {
    ...
    //FLAGS
    KRATOS_REGISTER_VARIABLE(IS_DEFINED_MULTIPHASE)
    ...
    KRATOS_REGISTER_VARIABLE(FACE_CONCENTRATION_FLUX)//扩散

    //CONSTITUTIVE LAW AND PROPERTIES
    KRATOS_REGISTER_VARIABLE(CONSTITUTIVE_LAW)
    KRATOS_REGISTER_VARIABLE(DENSITY)
    //phase trans
    KRATOS_REGISTER_VARIABLE(PHASE_TRANSFORMATION_LAW)
    KRATOS_REGISTER_VARIABLE(KINETICS_MODEL)
    KRATOS_REGISTER_VARIABLE(PARTITION_MODEL)
    KRATOS_REGISTER_VARIABLE(TRIP_MODEL)
    KRATOS_REGISTER_VARIABLE(CREEP_MODEL)
    //密度
    ...
    KRATOS_REGISTER_VARIABLE(YOUNG_MODULUS_AUSTENITE )
    KRATOS_REGISTER_VARIABLE(YOUNG_MODULUS_FERRITE )
    KRATOS_REGISTER_VARIABLE(YOUNG_MODULUS_CEMENTITE )
    KRATOS_REGISTER_VARIABLE(YOUNG_MODULUS_PEARLITE )
    KRATOS_REGISTER_VARIABLE(YOUNG_MODULUS_UPPER_BAINITE )
    KRATOS_REGISTER_VARIABLE(YOUNG_MODULUS_LOWER_BAINITE )
    KRATOS_REGISTER_VARIABLE(YOUNG_MODULUS_MARTENSITE )
    ...
    KRATOS_REGISTER_VARIABLE(CONCENTRATION_DIFFUSION_SETTINGS)//添加扩散模块
    ...
    KRATOS_REGISTER_VARIABLE(CONCEN_CONVECTION_COEFFICIENT) //扩散模块面对流
    ...
    KRATOS_REGISTER_VARIABLE(LATENT_BAINITIC)
    KRATOS_REGISTER_VARIABLE(LATENT_MARTENSITIC)
    ...
    KRATOS_REGISTER_VARIABLE(DIFFUSE_CONDCTIVITY_AUSTENITE )
    KRATOS_REGISTER_VARIABLE(DIFFUSE_CONDCTIVITY_FERRITE )
    KRATOS_REGISTER_VARIABLE(DIFFUSE_CONDCTIVITY_CEMENTITE )
    KRATOS_REGISTER_VARIABLE(DIFFUSE_CONDCTIVITY_PEARLITE )
    KRATOS_REGISTER_VARIABLE(DIFFUSE_CONDCTIVITY_UPPER_BAINITE )
    KRATOS_REGISTER_VARIABLE(DIFFUSE_CONDCTIVITY_LOWER_BAINITE )
    KRATOS_REGISTER_VARIABLE(DIFFUSE_CONDCTIVITY_MARTENSITE )
    //比热
