    ...
    double& rAccumulatedPlasticStrain)
{
    ...
    if( r_constitutive_law_options.Is(ConstitutiveLaw::COMPUTE_STRESS) ||
        ...
        trial_yield_function = this->YieldFunction(norm_trial_stress_dev, rValues, mAccumulatedPlasticStrain);
...
{
    const Table plastic_strain_stress_table = rMaterialProperties.GetTable(PLASTIC_STRAIN_VECTOR_PLASTICITY_POINT, 
...
{
    const Properties& r_material_properties = rValues.GetMaterialProperties();
    KRATOS_ERROR_IF(!(r_material_properties.HasTable(PLASTIC_STRAIN_VECTOR_PLASTICITY_POINT, EQUIVALENT_STRESS_VECTOR_PLASTICITY_POINT))) 
                    << "No Table for Eq_Stress - Eq_PlasticStrain" << std::endl;
    const Table plastic_strain_stress_table = r_material_properties.GetTable(PLASTIC_STRAIN_VECTOR_PLASTICITY_POINT,
                                                                             EQUIVALENT_STRESS_VECTOR_PLASTICITY_POINT);
