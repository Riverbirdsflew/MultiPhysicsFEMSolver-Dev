...
#if !defined(KRATOS_RESIDUALBASED_THERMAL_CONDUCTION_STRATEGY_NONLINEAR )
#define  KRATOS_RESIDUALBASED_THERMAL_CONDUCTION_STRATEGY_NONLINEAR
...
template<class TSparseSpace,
         ...
         class TLinearSolver
         >
class ResidualBasedThermalConductionStrategyNonLinear
...
public:
    ...
    KRATOS_CLASS_POINTER_DEFINITION(ResidualBasedThermalConductionStrategyNonLinear);
    ...
    ResidualBasedThermalConductionStrategyNonLinear(
    ...
    /** Destructor.
     */
    virtual ~ResidualBasedThermalConductionStrategyNonLinear()
    {
    }
...
private:
    ...
    /** Copy constructor.
     */
    ResidualBasedThermalConductionStrategyNonLinear(const ResidualBasedThermalConductionStrategyNonLinear& Other);
...
#endif /* KRATOS_RESIDUALBASED_THERMAL_CONDUCTION_STRATEGY_NONLINEAR  defined */
