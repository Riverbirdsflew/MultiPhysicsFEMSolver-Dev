    ...
    const ProcessInfo& rCurrentProcessInfo)
{
    ...
    for (IndexType i_gauss = 0; i_gauss < n_gauss; ++i_gauss) {
        ...
        const auto body_force = GetBodyForce(r_geometry.IntegrationPoints(GetIntegrationMethod()), i_gauss, cons_law_values);
    ...
    ConstitutiveLaw::Parameters& rValues) const
{
    ...
    const auto aux_body_force = StructuralAnalysisElementUtilities::GetBodyForce(*this, rIntegrationPoints, PointNumber, rValues);
    ...
    ) const
{
    ...
    StructuralAnalysisElementUtilities::CalculateB(*this, rDN_DX, rB);
...
{
    StructuralAnalysisElementUtilities::ComputeEquivalentF(*this, rStrainTensor, rF);
}
