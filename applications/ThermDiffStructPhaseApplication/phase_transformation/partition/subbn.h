 ...
 * Base class of trip.
 */
class KRATOS_API(THERM_DIFF_STRUCT_PHASE_APPLICATION) SubBn : public PartitionModel
{
public:
     ...
     */
    KRATOS_CLASS_POINTER_DEFINITION(SubBn);
