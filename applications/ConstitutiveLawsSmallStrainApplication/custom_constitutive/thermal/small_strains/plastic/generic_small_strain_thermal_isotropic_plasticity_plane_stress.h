...
class KRATOS_API(CONSTITUTIVE_LAWS_SMALL_STRAIN_APPLICATION) GenericSmallStrainThermalIsotropicPlasticityPlaneStress
    : public GenericSmallStrainThermalIsotropicPlasticity<TConstLawIntegratorType>
{
public:
    ///@name Type Definitions
    ///@{
    ...
    using BaseType = GenericSmallStrainThermalIsotropicPlasticity<TConstLawIntegratorType>;
    ...
    KRATOS_CLASS_POINTER_DEFINITION(GenericSmallStrainThermalIsotropicPlasticityPlaneStress);
    ...
    * Default constructor.
    */
    GenericSmallStrainThermalIsotropicPlasticityPlaneStress()
    {
    }
    ...
    */
    ...
    {
        return Kratos::make_shared<GenericSmallStrainThermalIsotropicPlasticityPlaneStress<TConstLawIntegratorType>>(*this);
    }

    /**
    * Copy constructor.
    */
    GenericSmallStrainThermalIsotropicPlasticityPlaneStress(const GenericSmallStrainThermalIsotropicPlasticityPlaneStress &rOther)
        : BaseType(rOther)
    {
    }
    ...
    * Destructor.
    */
    ~GenericSmallStrainThermalIsotropicPlasticityPlaneStress() override
    {
    }
...
private:
    ...
    {
        KRATOS_SERIALIZE_SAVE_BASE_CLASS(rSerializer, GenericSmallStrainThermalIsotropicPlasticity<TConstLawIntegratorType>)
    }

    void load(Serializer &rSerializer) override
    {
        KRATOS_SERIALIZE_LOAD_BASE_CLASS(rSerializer, GenericSmallStrainThermalIsotropicPlasticity<TConstLawIntegratorType>)
    }
