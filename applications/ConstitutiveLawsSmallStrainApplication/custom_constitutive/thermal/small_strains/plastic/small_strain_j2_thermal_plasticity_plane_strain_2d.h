...
/**
 * @class J2ThermalPlasticityPlaneStrain2D
 ...
 * @author whf
 */
class KRATOS_API(CONSTITUTIVE_LAWS_SMALL_STRAIN_APPLICATION) SmallStrainJ2ThermalPlasticityPlaneStrain2D
...
public:
    ...
    // Counted pointer
    KRATOS_CLASS_POINTER_DEFINITION(SmallStrainJ2ThermalPlasticityPlaneStrain2D);
     ...
     */
    SmallStrainJ2ThermalPlasticityPlaneStrain2D();

    /**
     * @brief Copy constructor.
     */
    SmallStrainJ2ThermalPlasticityPlaneStrain2D(const SmallStrainJ2ThermalPlasticityPlaneStrain2D& rOther);

    /**
     * @brief Destructor.
     */
    ~SmallStrainJ2ThermalPlasticityPlaneStrain2D() override;
    ...
    std::string Info() const override
    {
        ...
        buffer << "SmallStrainJ2ThermalPlasticityPlaneStrain2D";
        return buffer.str();
    }
    /// Print object's data.
    void PrintData(std::ostream& rOStream) const override {
        rOStream << "J2 Thermal Plasticity Plane Strain 2D constitutive law\n";
    };
...
}; // Class SmallStrainJ2ThermalPlasticityPlaneStrain2D
} // namespace Kratos.
