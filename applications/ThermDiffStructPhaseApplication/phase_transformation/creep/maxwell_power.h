...
#if !defined(KRATOS_MWPOWER)
#define  KRATOS_MWPOWER
 ...
 */
class KRATOS_API(THERM_DIFF_STRUCT_PHASE_APPLICATION) MWPower : public CreepModel
{
public:
    ...
    typedef MWPower* PointerType;


    /**
     * Counted pointer of phase transition model
     */
    KRATOS_CLASS_POINTER_DEFINITION(MWPower);
