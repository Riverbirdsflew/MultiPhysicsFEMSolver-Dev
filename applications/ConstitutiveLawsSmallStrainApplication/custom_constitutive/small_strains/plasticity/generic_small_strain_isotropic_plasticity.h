...
class KRATOS_API(CONSTITUTIVE_LAWS_SMALL_STRAIN_APPLICATION) GenericSmallStrainIsotropicPlasticity
    : public std::conditional<TConstLawIntegratorType::VoigtSize == 6, ElasticIsotropic3D, LinearPlaneStrain >::type // 根据VoigtSize的值是否为6决定继承自哪个类
{
public:
    ///@name Type Definitions
    ///@{
