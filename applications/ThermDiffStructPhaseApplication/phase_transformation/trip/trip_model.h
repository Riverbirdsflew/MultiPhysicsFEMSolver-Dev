 ...
 * Base class of trip.
 */
class KRATOS_API(THERM_DIFF_STRUCT_PHASE_APPLICATION) TripModel
{
public:
...
void AddKratosComponent(std::string const& Name, TripModel const& ThisComponent);
void AddKratosComponent(std::string const& Name, Variable<TripModel::Pointer> const& ThisComponent);
