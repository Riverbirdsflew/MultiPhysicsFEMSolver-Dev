...
public:
   ...
   enum StrainMeasure
   {
    ...
    // add flags for calculation 
    KRATOS_DEFINE_LOCAL_FLAG( COMPUTE_PHASE_TRANSFORMATION_STRAIN );
    KRATOS_DEFINE_LOCAL_FLAG( COMPUTE_THERMAL_STRAIN );
    KRATOS_DEFINE_LOCAL_FLAG( COMPUTE_CREEP );
    KRATOS_DEFINE_LOCAL_FLAG( COMPUTE_TRIP );
