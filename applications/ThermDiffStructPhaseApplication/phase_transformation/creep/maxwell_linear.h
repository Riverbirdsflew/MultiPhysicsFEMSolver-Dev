...
#if !defined(KRATOS_MWLINE)
#define  KRATOS_MWLINE
...
/**
 * Derived class of creep.
 */
class KRATOS_API(THERM_DIFF_STRUCT_PHASE_APPLICATION) MWLine : public CreepModel
{
public:
    ...
    typedef CreepModel BaseType;
    typedef MWLine* PointerType;


    /**
     * Counted pointer of phase transition model
     */
    KRATOS_CLASS_POINTER_DEFINITION(MWLine);
...
protected:
    ...
    ///@{
    /*double factor_a;
    double factor_stress;
    double factor_creep;
    double factor_temperature;
    double factor_time;*/

    // Pointer to the factors
    Variable<double>* mPara[5];
    PhaseType mType;
