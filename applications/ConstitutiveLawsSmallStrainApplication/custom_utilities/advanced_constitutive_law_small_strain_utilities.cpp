...
void AdvancedConstitutiveLawSmallStrainUtilities<TVoigtSize>::CalculateI2Invariant(
...
template<SizeType TVoigtSize>
void AdvancedConstitutiveLawSmallStrainUtilities<TVoigtSize>::CalculateI3Invariant(
    const BoundedVectorType& rStressVector,
    double& rI3
    )
{
...
template<SizeType TVoigtSize>
void AdvancedConstitutiveLawSmallStrainUtilities<TVoigtSize>::CalculateJ3Invariant(
...
template<SizeType TVoigtSize>
void AdvancedConstitutiveLawSmallStrainUtilities<TVoigtSize>::CalculateFirstVector(BoundedVectorType& rFirstVector)
{
    if constexpr (Dimension == 2) {
        rFirstVector[0] = 1.0;
        rFirstVector[1] = 1.0;
...
template<SizeType TVoigtSize>
void AdvancedConstitutiveLawSmallStrainUtilities<TVoigtSize>::CalculateSecondVector(
    const BoundedVectorType& rDeviator,
    const double J2,
...
template<SizeType TVoigtSize>
void AdvancedConstitutiveLawSmallStrainUtilities<TVoigtSize>::CalculateThirdVector(
    const BoundedVectorType& rDeviator,
    const double J2,
...
template<SizeType TVoigtSize>
void AdvancedConstitutiveLawSmallStrainUtilities<TVoigtSize>::CalculateLodeAngle(
    const double J2,
    const double J3,
    double& rLodeAngle
    )
...
template<SizeType TVoigtSize>
double AdvancedConstitutiveLawSmallStrainUtilities<TVoigtSize>::CalculateCharacteristicLength(const GeometryType& rGeometry)
{
    double radius = 0.0;
...
template<SizeType TVoigtSize>
double AdvancedConstitutiveLawSmallStrainUtilities<TVoigtSize>::CalculateCharacteristicLengthOnReferenceConfiguration(const GeometryType& rGeometry)
{
    double radius = 0.0;
...
template<SizeType TVoigtSize>
Matrix AdvancedConstitutiveLawSmallStrainUtilities<TVoigtSize>::ComputeEquivalentSmallDeformationDeformationGradient(const Vector& rStrainVector)
{
...
template<SizeType TVoigtSize>
void AdvancedConstitutiveLawSmallStrainUtilities<TVoigtSize>::CalculateAlmansiStrain(
...
template<SizeType TVoigtSize>
void AdvancedConstitutiveLawSmallStrainUtilities<TVoigtSize>::CalculateHenckyStrain(
...
template<SizeType TVoigtSize>
void AdvancedConstitutiveLawSmallStrainUtilities<TVoigtSize>::CalculateBiotStrain(
    const MatrixType& rCauchyTensor,
    Vector& rStrainVector
    )
{
...
template<>
void AdvancedConstitutiveLawSmallStrainUtilities<6>::CalculatePrincipalStresses(
...
template<>
void AdvancedConstitutiveLawSmallStrainUtilities<3>::CalculatePrincipalStresses(
    array_1d<double, Dimension>& rPrincipalStressVector,
    const BoundedVectorType& rStressVector
    )
{
...
template<SizeType TVoigtSize>
void AdvancedConstitutiveLawSmallStrainUtilities<TVoigtSize>::CalculatePrincipalStressesWithCardano(
    array_1d<double, Dimension>& rPrincipalStressVector,
    const BoundedVectorType& rStressVector
    )
{
...
template<SizeType TVoigtSize>
void AdvancedConstitutiveLawSmallStrainUtilities<TVoigtSize>::SpectralDecomposition(
    const BoundedVectorType& rStressVector,
...
template<SizeType TVoigtSize>
Matrix AdvancedConstitutiveLawSmallStrainUtilities<TVoigtSize>::CalculateLinearPlasticDeformationGradientIncrement(
...
template<SizeType TVoigtSize>
Matrix AdvancedConstitutiveLawSmallStrainUtilities<TVoigtSize>::CalculateElasticDeformationGradient(
    const MatrixType& rF,
...
template<SizeType TVoigtSize>
Matrix AdvancedConstitutiveLawSmallStrainUtilities<TVoigtSize>::CalculatePlasticDeformationGradientFromElastic(
    const MatrixType& rF,
...
template<SizeType TVoigtSize>
void AdvancedConstitutiveLawSmallStrainUtilities<TVoigtSize>::CalculatePlasticStrainFromFp(
    const MatrixType& rFp,
...
template<SizeType TVoigtSize>
Matrix AdvancedConstitutiveLawSmallStrainUtilities<TVoigtSize>::CalculateExponentialElasticDeformationGradient(
...
template<SizeType TVoigtSize>
Matrix AdvancedConstitutiveLawSmallStrainUtilities<TVoigtSize>::CalculateDirectElasticDeformationGradient(
...
template<SizeType TVoigtSize>
Matrix AdvancedConstitutiveLawSmallStrainUtilities<TVoigtSize>::CalculateExponentialPlasticDeformationGradientIncrement(
    const BoundedVectorType& rPlasticPotentialDerivative,
    const double PlasticConsistencyFactorIncrement,
    const MatrixType& rRe
    )
...
template<SizeType TVoigtSize>
Matrix AdvancedConstitutiveLawSmallStrainUtilities<TVoigtSize>::CalculateDirectPlasticDeformationGradientIncrement(
    const BoundedVectorType& rPlasticPotentialDerivative,
    const double PlasticConsistencyFactorIncrement,
    const MatrixType& rRe
    )
...
template<SizeType TVoigtSize>
void AdvancedConstitutiveLawSmallStrainUtilities<TVoigtSize>::CalculateRotationOperatorEuler1(
...
template<SizeType TVoigtSize>
void AdvancedConstitutiveLawSmallStrainUtilities<TVoigtSize>::CalculateRotationOperatorEuler2(
...
template<SizeType TVoigtSize>
void AdvancedConstitutiveLawSmallStrainUtilities<TVoigtSize>::CalculateRotationOperatorEuler3(
    const double EulerAngle3,
    BoundedMatrix<double, 3, 3>& rRotationOperator
    )
{
    AdvancedConstitutiveLawSmallStrainUtilities<TVoigtSize>::CalculateRotationOperatorEuler1(EulerAngle3, rRotationOperator);
}
...
template<SizeType TVoigtSize>
void AdvancedConstitutiveLawSmallStrainUtilities<TVoigtSize>::CalculateRotationOperator(
...
template<SizeType TVoigtSize>
double AdvancedConstitutiveLawSmallStrainUtilities<TVoigtSize>::MacaullyBrackets(const double Number)
...
template<SizeType TVoigtSize>
double AdvancedConstitutiveLawSmallStrainUtilities<TVoigtSize>::GetMaterialPropertyThroughAccessor(
...
template<SizeType TVoigtSize>
double AdvancedConstitutiveLawSmallStrainUtilities<TVoigtSize>::GetPropertyFromTemperatureTable(
    const Variable<double>& rVariable,
    ConstitutiveLaw::Parameters &rValues,
...
template class AdvancedConstitutiveLawSmallStrainUtilities<3>;
template class AdvancedConstitutiveLawSmallStrainUtilities<6>;
