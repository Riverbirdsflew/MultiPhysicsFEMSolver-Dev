...
PYBIND11_MODULE(KratosConstitutiveLawsSmallStrainApplication,m)
{
    ...
    KRATOS_REGISTER_IN_PYTHON_VARIABLE(m, EQUIVALENT_STRESS_VECTOR_PLASTICITY_POINT)
    KRATOS_REGISTER_IN_PYTHON_VARIABLE(m, PLASTIC_STRAIN_VECTOR_PLASTICITY_POINT)
