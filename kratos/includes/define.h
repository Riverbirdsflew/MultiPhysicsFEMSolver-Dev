...
#ifdef  KRATOS_REGISTER_PHASE_TRANSFORMATION_LAW
#undef  KRATOS_REGISTER_PHASE_TRANSFORMATION_LAW
#endif
#define  KRATOS_REGISTER_PHASE_TRANSFORMATION_LAW(name, reference)                                                           \
    KratosComponents<PhaseTransformationLaw>::Add(name, reference);                                                        \
    if(!Registry::HasItem("phase_transformation_law."+Registry::GetCurrentSource()+"."+name) &&                            \
       !Registry::HasItem("components."+std::string(name))){                                                                     \
        Registry::AddItem<RegistryItem>("phase_transformation_law."+Registry::GetCurrentSource()+"."+name);                \
        Registry::AddItem<RegistryItem>("components."+std::string(name));                                                        \
    }                                                                                                               \
    Serializer::Register(name, reference);

#ifdef  KRATOS_REGISTER_KINETICS_MODEL
#undef  KRATOS_REGISTER_KINETICS_MODEL
#endif
#define  KRATOS_REGISTER_KINETICS_MODEL(name, reference)                                                           \
    KratosComponents<KineticsModel>::Add(name, reference);                                                        \
    if(!Registry::HasItem("kinetics_model."+Registry::GetCurrentSource()+"."+name) &&                            \
       !Registry::HasItem("components."+std::string(name))){                                                                     \
        Registry::AddItem<RegistryItem>("kinetics_model."+Registry::GetCurrentSource()+"."+name);                \
        Registry::AddItem<RegistryItem>("components."+std::string(name));                                                        \
    }                                                                                                               \
    Serializer::Register(name, reference);

#ifdef  KRATOS_REGISTER_PARTITION_MODEL
#undef  KRATOS_REGISTER_PARTITION_MODEL
#endif
#define  KRATOS_REGISTER_PARTITION_MODEL(name, reference)                                                           \
    KratosComponents<PartitionModel>::Add(name, reference);                                                        \
    if(!Registry::HasItem("partition_model."+Registry::GetCurrentSource()+"."+name) &&                            \
       !Registry::HasItem("components."+std::string(name))){                                                                     \
        Registry::AddItem<RegistryItem>("partition_model."+Registry::GetCurrentSource()+"."+name);                \
        Registry::AddItem<RegistryItem>("components."+std::string(name));                                                        \
    }                                                                                                               \
    Serializer::Register(name, reference);

#ifdef  KRATOS_REGISTER_TRIP_MODEL
#undef  KRATOS_REGISTER_TRIP_MODEL
#endif
#define  KRATOS_REGISTER_TRIP_MODEL(name, reference)                                                           \
    KratosComponents<TripModel>::Add(name, reference);                                                        \
    if(!Registry::HasItem("trip_model."+Registry::GetCurrentSource()+"."+name) &&                            \
       !Registry::HasItem("components."+std::string(name))){                                                                     \
        Registry::AddItem<RegistryItem>("trip_model."+Registry::GetCurrentSource()+"."+name);                \
        Registry::AddItem<RegistryItem>("components."+std::string(name));                                                        \
    }                                                                                                               \
    Serializer::Register(name, reference);

#ifdef  KRATOS_REGISTER_CREEP_MODEL
#undef  KRATOS_REGISTER_CREEP_MODEL
#endif
#define  KRATOS_REGISTER_CREEP_MODEL(name, reference)                                                           \
    KratosComponents<CreepModel>::Add(name, reference);                                                        \
    if(!Registry::HasItem("creep_model."+Registry::GetCurrentSource()+"."+name) &&                            \
       !Registry::HasItem("components."+std::string(name))){                                                                     \
        Registry::AddItem<RegistryItem>("creep_model."+Registry::GetCurrentSource()+"."+name);                \
        Registry::AddItem<RegistryItem>("components."+std::string(name));                                                        \
    }                                                                                                               \
    Serializer::Register(name, reference);
