...
public:
    ...
    * @brief This  script  calculates  the derivatives  of the plastic potential
        ...
        )
    {
        ...
        AdvancedConstitutiveLawSmallStrainUtilities<VoigtSize>::CalculateFirstVector(first_vector);
        AdvancedConstitutiveLawSmallStrainUtilities<VoigtSize>::CalculateSecondVector(rDeviator, J2, second_vector);
        AdvancedConstitutiveLawSmallStrainUtilities<VoigtSize>::CalculateThirdVector(rDeviator, J2, third_vector);
