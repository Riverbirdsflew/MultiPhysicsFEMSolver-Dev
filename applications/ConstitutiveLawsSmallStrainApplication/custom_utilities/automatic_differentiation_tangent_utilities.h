...
///@{
/**
 * @class AdvancedConstitutiveLawSmallStrainUtilities
 ...
 * @details The python sympy files that generate the c++ code can be found in applications/ConstitutiveLawsSmallStrainApplication/python_scripts/symbolic_generation/iso_damage_tangent_tensor
...
class KRATOS_API(CONSTITUTIVE_LAWS_SMALL_STRAIN_APPLICATION) AutomaticDifferentiationTangentUtilities
{
  public:
    ///@name Type definitions
    ///@{
