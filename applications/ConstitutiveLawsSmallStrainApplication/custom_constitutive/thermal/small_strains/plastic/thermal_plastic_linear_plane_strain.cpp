...
void ThermalPlasticLinearPlaneStrain::CalculatePK2Stress(
...
void ThermalPlasticLinearPlaneStrain::CalculateElasticMatrix(
...
void ThermalPlasticLinearPlaneStrain::SubstractThermalStrain(
...
{
    AdvancedConstitutiveLawSmallStrainUtilities<3>::SubstractThermalStrain(rStrainVector, ReferenceTemperature, rParameters, true);
}

/***********************************************************************************/
/***********************************************************************************/

void ThermalPlasticLinearPlaneStrain::CalculateCauchyGreenStrain(
    Parameters& rValues,
    ConstitutiveLaw::StrainVectorType& rStrainVector
    )
{
