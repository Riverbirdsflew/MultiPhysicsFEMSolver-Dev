 ...
 */
class KRATOS_API(STRUCTURAL_ANALYSIS_APPLICATION) BaseSolidElement
    : public Element
{
protected:
    /**
...
protected:
    ...
    */
    void CalculateShapeGradientOfMassMatrix(MatrixType& rMassMatrix, ShapeParameter Deriv, const ProcessInfo& rCurrentProcessInfo) const;
